...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:jnl="urn:hch-jnl-BB4C2D71-E80A-4fe7-B7D8-FDAF121D7AD6"  xmlns:tbl="urn:hch:table-470CC8FB-4DFD-4003-9403-2FE04FAB5760" exclude-result-prefixes="jnl tbl xsl" >
...
<xsl:value-of select="translate($TypeCodes , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:when>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BJR' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bjr'">
<xsl:value-of select="'bjr'"/>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'IMJ' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'imj'">
<xsl:value-of select="'imj'"/>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'DMF' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'dmf'">
...
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BFN'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bfn'">
<xsl:text>99</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BNP' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bnp'">
<xsl:text>99</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BST' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bst'">
<xsl:text>88</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BBM' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bbm'">
<xsl:text>88</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BIP' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bip'">
<xsl:text>88</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BQC' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bqc'">
<xsl:text>88</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BTC' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'btc'">
<xsl:text>88</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BBN' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bbn'">
<xsl:text>77</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BEH' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'beh'">
<xsl:text>66</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BMH' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bmh'">
<xsl:text>55</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BSM'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bsm'">
<xsl:text>6</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BEP'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bem'">
<xsl:text>3</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BPN' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bpn'">
<xsl:text>6</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BDT' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bdt'">
<xsl:text>1</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BCO' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bco'">
<xsl:text>1</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BMP' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bmp'">
<xsl:text>6</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BME' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bme'">
<xsl:text>6</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BEM' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bem'">
<xsl:text>6</xsl:text>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BHT' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bht'">
...
<xsl:text>-</xsl:text>
<xsl:choose>
<xsl:when test="string-length($ffpage) = 3">
</xsl:when>
...
<xsl:value-of select="translate($CustCode , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
<xsl:text>-</xsl:text>
<xsl:choose>
<xsl:when test="string-length($fvolume) = 1">
<xsl:text>0</xsl:text>
...
<xsl:variable name="JrnalCode">
</xsl:variable>
<xsl:variable name="CorresAuthor">
<xsl:text>0</xsl:text>
</xsl:variable>
<xsl:variable name="OneLine"><xsl:text>yes</xsl:text></xsl:variable>
...
<xsl:when test="ancestor::jnl:cit and parent::jnl:othinfo[not(preceding-sibling::node())]">
<xsl:apply-templates />
</xsl:when>
<xsl:otherwise>
<xsl:text disable-output-escaping="yes">&lt;ext-link ext-link-type="uri" xlink:href="</xsl:text>
...
<xsl:variable name="fid"><xsl:value-of select="substring-after(@id,'tbl')"/></xsl:variable>
...
<xsl:variable name="fids"><xsl:value-of select="@id"/></xsl:variable>
...
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BIN'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bin'">
...
<xsl:text>Table </xsl:text><xsl:apply-templates select="@num"/>
<xsl:text>.</xsl:text>
</xsl:element>
</xsl:if>
...
<xsl:value-of disable-output-escaping="yes" select="substring-after($doi, 'bio.')"/>
</xsl:when>
<xsl:when test="starts-with($doi , 'BIO.')">
<xsl:value-of disable-output-escaping="yes" select="substring-after($doi, 'BIO.')"/>
</xsl:when>
...
<xsl:value-of disable-output-escaping="yes" select="substring-after($doi, 'bin.')"/>
</xsl:when>
<xsl:when test="starts-with($doi , 'BIN.')">
<xsl:value-of disable-output-escaping="yes" select="substring-after($doi, 'BIN.')"/>
</xsl:when>
...
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'CES'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'ces'">
<xsl:variable name="doi">
<xsl:apply-templates select="//jnl:unit-info[1]/jnl:c-tracker-id/."/>
</xsl:variable>
...
<xsl:value-of disable-output-escaping="yes" select="substring-after($doi, 'ces.')"/>
</xsl:when>
<xsl:when test="starts-with($doi , 'CES.')">
<xsl:value-of disable-output-escaping="yes" select="substring-after($doi, 'CES.')"/>
</xsl:when>
...
<xsl:variable name="first"><xsl:value-of select="substring-after(text()[1]/.,'Table ')"/></xsl:variable>
<xsl:variable name="second"><xsl:value-of select="substring-after($first,' ')"/></xsl:variable>
...
<xsl:element name="fn">
<xsl:attribute name="id"><xsl:text>nt</xsl:text><xsl:value-of select="substring-after(@id,'tfootnote') + 100"/></xsl:attribute>
<xsl:if test="@num">
<xsl:element name="label">
...
<xsl:variable name="namee"><xsl:value-of select="substring-after(@nameend,'col')"/></xsl:variable>
<xsl:variable name="names"><xsl:value-of select="substring-after(@namest,'col')"/></xsl:variable>
...
<xsl:variable name="gid"><xsl:value-of select="jnl:graphic/@id"/></xsl:variable>
...
<xsl:choose>
<xsl:when test="node()[position() = 1 and self::text()] and contains(node()[position() = 1 and self::text()]/. , 'Fig')">
...
<xsl:choose>
<xsl:when test="node()[position() = 2 and self::text()[. = ' ']] and node()[position() &gt; 2]">
<xsl:element name="p">
<xsl:apply-templates select="node()[position() > 2]"/>
</xsl:element>
</xsl:when>
...
<xsl:when test="node()[position() = 2 and self::text()[. = ' ']] and node()[position() = 3 and self::jnl:emph[@type = 'bold']]">
<xsl:element name="title">
<xsl:apply-templates select="node()[position() = 3]/node()"/>
</xsl:element>
<xsl:choose>
<xsl:when test="node()[position() = 4 and self::text()[. = ' ']] and node()[position() &gt; 4]">
<xsl:element name="p">
<xsl:apply-templates select="node()[position() > 4]"/>
</xsl:element>
</xsl:when>
<xsl:when test="node()[position() = 4 and self::text()[starts-with(. , ' ')]]">
<xsl:element name="p">
<xsl:value-of select="substring-after(node()[position() = 4]/. ,' ')"/>
<xsl:apply-templates select="node()[position() > 4]"/>
</xsl:element>
</xsl:when>
...
<xsl:when test="node()[position() = 1 and self::jnl:emph[@type = 'bold']] and node()[position() = 2 and self::processing-instruction('ENTCHAR')[. = 'emsp']]">
<xsl:apply-templates select="node()[position() > 2]"/>
</xsl:when>
<xsl:when test="node()[position() = 1 and self::jnl:emph[@type = 'bold']]">
<xsl:variable name="contents">
...
<xsl:when test="@type='italic' and parent::jnl:p[@type = 'genus-normal-para' or @type = 'genus-small-para']">
...
<xsl:variable name="first"><xsl:value-of select="substring-before($Chars,' ')"/></xsl:variable>
<xsl:variable name="rest"><xsl:value-of select="substring-after($Chars,' ')"/></xsl:variable>
<xsl:choose>
<xsl:when test="$first != ''">
...
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()[. = '#146']]">
<xsl:value-of select="$content1"/>
</xsl:when>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()[. = 'hyphen']]">
<xsl:value-of select="$content1"/>
</xsl:when>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()[. = 'ensp']]">
<xsl:value-of select="$content1"/>
</xsl:when>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()[. = 'emsp14']]">
<xsl:value-of select="$content1"/>
</xsl:when>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()[. = 'mdash']]">
<xsl:value-of select="$content1"/>
</xsl:when>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()[. = 'ndash']]">
<xsl:value-of select="$content1"/>
</xsl:when>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()[. = 'emsp']]">
<xsl:value-of select="$content1"/>
</xsl:when>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()[. = 'apos']]">
<xsl:value-of select="$content1"/>
</xsl:when>
<xsl:when test="ancestor::jnl:surname[ancestor::jnl:author-grp] and preceding-sibling::node()[position() = 1 and self::processing-instruction()]">
<xsl:value-of select="translate($content1 , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:when>
<xsl:when test="ancestor::jnl:surname[ancestor::jnl:author-grp] and preceding-sibling::node()[position() = 1 and self::text()]">
<xsl:value-of select="translate($content1 , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$content1"/>
...
<xsl:choose>
<xsl:when test="$content = 'sol' and ancestor::jnl:doi"><xsl:text>/</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen' and ancestor::jnl:citref"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'ndash' and ancestor::jnl:citref"><xsl:text>-</xsl:text></xsl:when>

<xsl:when test="$content = 'lpar' and ancestor::jnl:cit"><xsl:text disable-output-escaping="yes">&amp;lpar;</xsl:text></xsl:when>
<xsl:when test="$content = 'rpar' and ancestor::jnl:cit"><xsl:text disable-output-escaping="yes">&amp;rpar;</xsl:text></xsl:when>

<xsl:when test="$content = 'colon' and ancestor::jnl:cit"><xsl:text>:</xsl:text></xsl:when>
<xsl:when test="$content = 'semi' and ancestor::jnl:cit"><xsl:text>;</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen' and ancestor::jnl:cit-tl"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen' and ancestor::jnl:pub-tl"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen' and ancestor::jnl:pub-name"><xsl:text>-</xsl:text></xsl:when>


<xsl:when test="$content = 'hyphen' and ancestor::jnl:cit"><xsl:text disable-output-escaping="yes">&amp;ndash;</xsl:text></xsl:when>


<xsl:when test="$content = 'commat' and ancestor::jnl:email"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:note[@type = 'email']"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:url"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:note[@type = 'url']"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen' and ancestor::jnl:email"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen' and ancestor::jnl:note[@type = 'email']"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen' and ancestor::jnl:url"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen' and ancestor::jnl:note[@type = 'url']"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'equals' and ancestor::jnl:email"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'equals' and ancestor::jnl:note[@type = 'email']"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'equals' and ancestor::jnl:url"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'equals' and ancestor::jnl:note[@type = 'url']"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'equal' and ancestor::jnl:email"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'equal' and ancestor::jnl:note[@type = 'email']"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'equal' and ancestor::jnl:url"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'equal' and ancestor::jnl:note[@type = 'url']"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'lpar' and ancestor::jnl:email"><xsl:text>(</xsl:text></xsl:when>
<xsl:when test="$content = 'lpar' and ancestor::jnl:note[@type = 'email']"><xsl:text>(</xsl:text></xsl:when>
<xsl:when test="$content = 'lpar' and ancestor::jnl:url"><xsl:text>(</xsl:text></xsl:when>
<xsl:when test="$content = 'lpar' and ancestor::jnl:note[@type = 'url']"><xsl:text>(</xsl:text></xsl:when>
<xsl:when test="$content = 'rpar' and ancestor::jnl:email"><xsl:text>)</xsl:text></xsl:when>
<xsl:when test="$content = 'rpar' and ancestor::jnl:note[@type = 'email']"><xsl:text>)</xsl:text></xsl:when>
<xsl:when test="$content = 'rpar' and ancestor::jnl:url"><xsl:text>)</xsl:text></xsl:when>
<xsl:when test="$content = 'rpar' and ancestor::jnl:note[@type = 'url']"><xsl:text>)</xsl:text></xsl:when>
<xsl:when test="$content = 'sol' and ancestor::jnl:email"><xsl:text>/</xsl:text></xsl:when>
<xsl:when test="$content = 'sol' and ancestor::jnl:url"><xsl:text>/</xsl:text></xsl:when>
<xsl:when test="$content = 'sol' and ancestor::jnl:note[@type = 'url']"><xsl:text>/</xsl:text></xsl:when>
<xsl:when test="$content = 'sol' and ancestor::jnl:note[@type = 'email']"><xsl:text>/</xsl:text></xsl:when>
<xsl:when test="$content = 'bsol' and ancestor::jnl:email"><xsl:text>\</xsl:text></xsl:when>
<xsl:when test="$content = 'bsol' and ancestor::jnl:url"><xsl:text>\</xsl:text></xsl:when>
<xsl:when test="$content = 'bsol' and ancestor::jnl:note[@type = 'url']"><xsl:text>\</xsl:text></xsl:when>
<xsl:when test="$content = 'bsol' and ancestor::jnl:note[@type = 'email']"><xsl:text>\</xsl:text></xsl:when>
<xsl:when test="$content = 'colon' and ancestor::jnl:email"><xsl:text>:</xsl:text></xsl:when>
<xsl:when test="$content = 'colon' and ancestor::jnl:url"><xsl:text>:</xsl:text></xsl:when>
<xsl:when test="$content = 'colon' and ancestor::jnl:note[@type = 'url']"><xsl:text>:</xsl:text></xsl:when>
<xsl:when test="$content = 'colon' and ancestor::jnl:note[@type = 'email']"><xsl:text>:</xsl:text></xsl:when>
<xsl:when test="$content = 'lowbar' and ancestor::jnl:email"><xsl:text>_</xsl:text></xsl:when>
<xsl:when test="$content = 'lowbar' and ancestor::jnl:url"><xsl:text>_</xsl:text></xsl:when>
<xsl:when test="$content = 'lowbar' and ancestor::jnl:note[@type = 'url']"><xsl:text>_</xsl:text></xsl:when>
<xsl:when test="$content = 'lowbar' and ancestor::jnl:note[@type = 'email']"><xsl:text>_</xsl:text></xsl:when>
<xsl:when test="$content = 'num' and ancestor::jnl:email"><xsl:text>#</xsl:text></xsl:when>
<xsl:when test="$content = 'num' and ancestor::jnl:url"><xsl:text>#</xsl:text></xsl:when>
<xsl:when test="$content = 'num' and ancestor::jnl:note[@type = 'url']"><xsl:text>#</xsl:text></xsl:when>
<xsl:when test="$content = 'num' and ancestor::jnl:note[@type = 'email']"><xsl:text>#</xsl:text></xsl:when>
<xsl:when test="$content = 'sim' and ancestor::jnl:email"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'sim' and ancestor::jnl:url"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'sim' and ancestor::jnl:note[@type = 'url']"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'sim' and ancestor::jnl:note[@type = 'email']"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'tilde' and ancestor::jnl:email"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'tilde' and ancestor::jnl:url"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'tilde' and ancestor::jnl:note[@type = 'url']"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'tilde' and ancestor::jnl:note[@type = 'email']"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'shy' and ancestor::jnl:email"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'shy' and ancestor::jnl:note[@type = 'email']"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'shy' and ancestor::jnl:url"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'shy' and ancestor::jnl:note[@type = 'url']"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'percnt' and ancestor::jnl:email"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'percnt' and ancestor::jnl:note[@type = 'email']"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'percnt' and ancestor::jnl:url"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'percnt' and ancestor::jnl:note[@type = 'url']"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'percent' and ancestor::jnl:email"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'percent' and ancestor::jnl:note[@type = 'email']"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'percent' and ancestor::jnl:url"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'percent' and ancestor::jnl:note[@type = 'url']"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'quest' and ancestor::jnl:email"><xsl:text>?</xsl:text></xsl:when>
<xsl:when test="$content = 'quest' and ancestor::jnl:note[@type = 'email']"><xsl:text>?</xsl:text></xsl:when>
<xsl:when test="$content = 'quest' and ancestor::jnl:url"><xsl:text>?</xsl:text></xsl:when>
<xsl:when test="$content = 'quest' and ancestor::jnl:note[@type = 'url']"><xsl:text>?</xsl:text></xsl:when>
<xsl:when test="$content = 'dollar' and ancestor::jnl:email"><xsl:text>$</xsl:text></xsl:when>
<xsl:when test="$content = 'dollar' and ancestor::jnl:note[@type = 'email']"><xsl:text>$</xsl:text></xsl:when>
<xsl:when test="$content = 'dollar' and ancestor::jnl:url"><xsl:text>$</xsl:text></xsl:when>
<xsl:when test="$content = 'dollar' and ancestor::jnl:note[@type = 'url']"><xsl:text>$</xsl:text></xsl:when>
<xsl:when test="$content = 'lsqb' and ancestor::jnl:email"><xsl:text>[</xsl:text></xsl:when>
<xsl:when test="$content = 'lsqb' and ancestor::jnl:note[@type = 'email']"><xsl:text>[</xsl:text></xsl:when>
<xsl:when test="$content = 'lsqb' and ancestor::jnl:url"><xsl:text>[</xsl:text></xsl:when>
<xsl:when test="$content = 'lsqb' and ancestor::jnl:note[@type = 'url']"><xsl:text>[</xsl:text></xsl:when>
<xsl:when test="$content = 'rsqb' and ancestor::jnl:email"><xsl:text>]</xsl:text></xsl:when>
<xsl:when test="$content = 'rsqb' and ancestor::jnl:note[@type = 'email']"><xsl:text>]</xsl:text></xsl:when>
<xsl:when test="$content = 'rsqb' and ancestor::jnl:url"><xsl:text>]</xsl:text></xsl:when>
<xsl:when test="$content = 'rsqb' and ancestor::jnl:note[@type = 'url']"><xsl:text>]</xsl:text></xsl:when>
<xsl:when test="$content = 'plus' and ancestor::jnl:email"><xsl:text>+</xsl:text></xsl:when>
<xsl:when test="$content = 'plus' and ancestor::jnl:note[@type = 'email']"><xsl:text>+</xsl:text></xsl:when>
<xsl:when test="$content = 'plus' and ancestor::jnl:url"><xsl:text>+</xsl:text></xsl:when>
<xsl:when test="$content = 'plus' and ancestor::jnl:note[@type = 'url']"><xsl:text>+</xsl:text></xsl:when>
<xsl:when test="$content = 'minus' and ancestor::jnl:email"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'minus' and ancestor::jnl:note[@type = 'email']"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'minus' and ancestor::jnl:url"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'minus' and ancestor::jnl:note[@type = 'url']"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'ast' and ancestor::jnl:email"><xsl:text>*</xsl:text></xsl:when>
<xsl:when test="$content = 'ast' and ancestor::jnl:note[@type = 'email']"><xsl:text>*</xsl:text></xsl:when>
<xsl:when test="$content = 'ast' and ancestor::jnl:url"><xsl:text>*</xsl:text></xsl:when>
<xsl:when test="$content = 'ast' and ancestor::jnl:note[@type = 'url']"><xsl:text>*</xsl:text></xsl:when>
<xsl:when test="$content = 'comma' and ancestor::jnl:email"><xsl:text>,</xsl:text></xsl:when>
<xsl:when test="$content = 'comma' and ancestor::jnl:note[@type = 'email']"><xsl:text>,</xsl:text></xsl:when>
<xsl:when test="$content = 'comma' and ancestor::jnl:url"><xsl:text>,</xsl:text></xsl:when>
<xsl:when test="$content = 'comma' and ancestor::jnl:note[@type = 'url']"><xsl:text>,</xsl:text></xsl:when>
<xsl:when test="$content = 'period' and ancestor::jnl:email"><xsl:text>.</xsl:text></xsl:when>
<xsl:when test="$content = 'period' and ancestor::jnl:note[@type = 'email']"><xsl:text>.</xsl:text></xsl:when>
<xsl:when test="$content = 'period' and ancestor::jnl:url"><xsl:text>.</xsl:text></xsl:when>
<xsl:when test="$content = 'period' and ancestor::jnl:note[@type = 'url']"><xsl:text>.</xsl:text></xsl:when>
<xsl:when test="$content = 'excl' and ancestor::jnl:email"><xsl:text>!</xsl:text></xsl:when>
<xsl:when test="$content = 'excl' and ancestor::jnl:note[@type = 'email']"><xsl:text>!</xsl:text></xsl:when>
<xsl:when test="$content = 'excl' and ancestor::jnl:url"><xsl:text>!</xsl:text></xsl:when>
<xsl:when test="$content = 'excl' and ancestor::jnl:note[@type = 'url']"><xsl:text>!</xsl:text></xsl:when>
<xsl:when test="$content = 'lcub' and ancestor::jnl:email"><xsl:text>{</xsl:text></xsl:when>
<xsl:when test="$content = 'lcub' and ancestor::jnl:note[@type = 'email']"><xsl:text>{</xsl:text></xsl:when>
<xsl:when test="$content = 'lcub' and ancestor::jnl:url"><xsl:text>{</xsl:text></xsl:when>
<xsl:when test="$content = 'lcub' and ancestor::jnl:note[@type = 'url']"><xsl:text>{</xsl:text></xsl:when>
<xsl:when test="$content = 'rcub' and ancestor::jnl:email"><xsl:text>}</xsl:text></xsl:when>
<xsl:when test="$content = 'rcub' and ancestor::jnl:note[@type = 'email']"><xsl:text>}</xsl:text></xsl:when>
<xsl:when test="$content = 'rcub' and ancestor::jnl:url"><xsl:text>}</xsl:text></xsl:when>
<xsl:when test="$content = 'rcub' and ancestor::jnl:note[@type = 'url']"><xsl:text>}</xsl:text></xsl:when>
<xsl:when test="$content = 'verbar' and ancestor::jnl:email"><xsl:text>|</xsl:text></xsl:when>
<xsl:when test="$content = 'verbar' and ancestor::jnl:note[@type = 'email']"><xsl:text>|</xsl:text></xsl:when>
<xsl:when test="$content = 'verbar' and ancestor::jnl:url"><xsl:text>|</xsl:text></xsl:when>
<xsl:when test="$content = 'verbar' and ancestor::jnl:note[@type = 'url']"><xsl:text>|</xsl:text></xsl:when>
<xsl:when test="$content = 'sim' and ancestor::jnl:email"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'sim' and ancestor::jnl:url"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'sim' and ancestor::jnl:note[@type = 'url']"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'sim' and ancestor::jnl:note[@type = 'email']"><xsl:text>~</xsl:text></xsl:when>
...
<xsl:when test="$content = 'tilde' and ancestor::jnl:note[@type = 'url']"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = 'tilde' and ancestor::jnl:note[@type = 'email']"><xsl:text>~</xsl:text></xsl:when>
<xsl:when test="$content = '#xa2' or $content = '#XA2'"><xsl:text>*</xsl:text></xsl:when>
<xsl:when test="$content = 'emsp'"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="$content = 'ensp'"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="$content = 'thinsp'"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="$content = '#146'"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="$content = '#6'"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="$content = 'colon'"><xsl:text>:</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:email"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'sol'"><xsl:text disable-output-escaping="yes">/</xsl:text></xsl:when>
<xsl:when test="$content = 'semi' and ancestor::jnl:othinfo[parent::jnl:cit[@type and @type = 'other'] and not(preceding-sibling::node()) and not(following-sibling::node())]">
<xsl:text disable-output-escaping="yes">&amp;semi;</xsl:text></xsl:when>
<xsl:when test="$content = 'semi'"><xsl:text disable-output-escaping="yes">;</xsl:text></xsl:when>
<xsl:when test="$content = 'quest'"><xsl:text disable-output-escaping="yes">?</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen'"><xsl:text>-</xsl:text></xsl:when>
<xsl:otherwise>
<xsl:text disable-output-escaping="yes">&amp;</xsl:text>
...
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction()]">
<xsl:value-of select="translate($content1 , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:when>
...
<xsl:when test="$content = 'quest'"><xsl:text disable-output-escaping="yes">?</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen'"><xsl:text>-</xsl:text></xsl:when>
<xsl:when test="$content = 'sol'"><xsl:text>/</xsl:text></xsl:when>
<xsl:otherwise>
<xsl:text disable-output-escaping="yes">&amp;</xsl:text>
<xsl:value-of select="$content"/>  
<xsl:text disable-output-escaping="yes">;</xsl:text>
...
<xsl:when test="$content = 'semi'"><xsl:text disable-output-escaping="yes">;</xsl:text></xsl:when>
<xsl:when test="$content = 'num'"><xsl:text disable-output-escaping="yes">#</xsl:text></xsl:when>
<xsl:when test="$content = 'quest'"><xsl:text disable-output-escaping="yes">?</xsl:text></xsl:when>
<xsl:when test="$content = 'dollar'"><xsl:text disable-output-escaping="yes">$</xsl:text></xsl:when>
<xsl:when test="$content = 'lsqu'"><xsl:text disable-output-escaping="yes">[</xsl:text></xsl:when>
<xsl:when test="$content = 'rsqu'"><xsl:text disable-output-escaping="yes">]</xsl:text></xsl:when>
<xsl:when test="$content = 'plus'"><xsl:text disable-output-escaping="yes">+</xsl:text></xsl:when>
<xsl:when test="$content = 'minus'"><xsl:text disable-output-escaping="yes">-</xsl:text></xsl:when>
<xsl:when test="$content = 'ast'"><xsl:text disable-output-escaping="yes">*</xsl:text></xsl:when>
<xsl:when test="$content = 'equal'"><xsl:text disable-output-escaping="yes">=</xsl:text></xsl:when>
<xsl:when test="$content = 'equals'"><xsl:text>=</xsl:text></xsl:when>
<xsl:when test="$content = 'percent'"><xsl:text>%</xsl:text></xsl:when>
<xsl:when test="$content = 'comma'"><xsl:text>,</xsl:text></xsl:when>
<xsl:when test="$content = 'period'"><xsl:text>.</xsl:text></xsl:when>
<xsl:when test="$content = 'excl'"><xsl:text>!</xsl:text></xsl:when>
<xsl:when test="$content = 'lcub'"><xsl:text>{</xsl:text></xsl:when>
<xsl:when test="$content = 'rcub'"><xsl:text>}</xsl:text></xsl:when>
<xsl:when test="$content = 'verbar'"><xsl:text>|</xsl:text></xsl:when>
<xsl:when test="$content = 'quest'"><xsl:text>?</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:email"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:note[@type = 'email']"><xsl:text>@</xsl:text></xsl:when>
...
<xsl:when test="$content = 'sol'"><xsl:text>/</xsl:text></xsl:when>
<xsl:when test="$content = 'colon'"><xsl:text>:</xsl:text></xsl:when>
<xsl:when test="$content = 'lowbar'"><xsl:text>_</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:email"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:note[@type = 'email']"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:url"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:note[@type = 'url']"><xsl:text>@</xsl:text></xsl:when>
...
<xsl:when test="$content = '#146' and following-sibling::node()[position() = 1 and self::jnl:citref]">
<xsl:text> </xsl:text>
</xsl:when>
<xsl:when test="$content = '#HELLO' and not(ancestor::jnl:caption[parent::jnl:fig]  and parent::jnl:tabref and parent::jnl:figref)">
<xsl:text> </xsl:text>
</xsl:when>
<xsl:when test="$content = 'amp'">
<xsl:text disable-output-escaping="yes">&amp;</xsl:text>
...
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'GHS'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'ghs'">
...
<xsl:value-of disable-output-escaping="yes" select="substring-after($content, 'bio.')"/>
</xsl:when>
<xsl:when test="starts-with($content , 'BIO.')">
<xsl:value-of disable-output-escaping="yes" select="substring-after($content, 'BIO.')"/>
</xsl:when>
...
<xsl:value-of disable-output-escaping="yes" select="substring-after($content, 'bin.')"/>
</xsl:when>
<xsl:when test="starts-with($content , 'BIN.')">
<xsl:value-of disable-output-escaping="yes" select="substring-after($content, 'BIN.')"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="starts-with($doi , 'ghs.') and string-length($doi) = 11">
<xsl:value-of disable-output-escaping="yes" select="substring(substring-after($doi, 'ghs.'),1,2)"/>
<xsl:text>-</xsl:text>
<xsl:value-of disable-output-escaping="yes" select="substring(substring-after($doi, 'ghs.'),3,5)"/>
</xsl:when>
<xsl:when test="starts-with($doi , 'GHS.') and string-length($doi) = 11">
<xsl:value-of disable-output-escaping="yes" select="substring(substring-after($doi, 'GHS.'),1,2)"/>
<xsl:text>-</xsl:text>
...
<xsl:when test="starts-with($doi , 'ghs') and string-length($doi) = 10">
<xsl:value-of disable-output-escaping="yes" select="substring(substring-after($doi, 'ghs'),1,2)"/>
<xsl:text>-</xsl:text>
<xsl:value-of disable-output-escaping="yes" select="substring(substring-after($doi, 'ghs'),3,5)"/>
</xsl:when>
...
<xsl:value-of disable-output-escaping="yes" select="substring-after($doi, 'ghs.')"/>
</xsl:when>
<xsl:when test="starts-with($doi , 'GHS.')">
<xsl:value-of disable-output-escaping="yes" select="substring-after($doi, 'GHS.')"/>
</xsl:when>
...
<xsl:for-each select="//jnl:unit-info[1]/jnl:rh-recto[node()]">
<xsl:element name="subject">
<xsl:variable name="Part1">
<xsl:apply-templates />
</xsl:variable>
<xsl:variable name="Part2">
<xsl:value-of select="translate($Part1 , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:variable>
<xsl:choose>
<xsl:when test="$Part2 = 'original paper' or $Part2 = 'original papers'">
...
<!-- hello -->
<xsl:choose>
<xsl:when test="//jnl:bmj-module-no/. = '5' and //jnl:jnl-info/jnl:abrv-jnl-tl = 'BHT'">
<xsl:element name="subj-group">
<xsl:attribute name="subj-group-type">
<xsl:text>heading</xsl:text>
</xsl:attribute>
<xsl:choose>
<xsl:when test="//jnl:article/jnl:front/jnl:title-grp/jnl:sub-tl/node()">
<xsl:for-each select="//jnl:article/jnl:front/jnl:title-grp/jnl:sub-tl[node()]">
<xsl:element name="subject">
...
<xsl:for-each select="//jnl:unit-info/jnl:rh-recto[. != '']">
<xsl:element name="subject">
<xsl:apply-templates />
</xsl:element>
</xsl:for-each>
...
<xsl:when test="//jnl:jnl-tl[. = 'BMJ Case Reports' or . = 'BMJ Case Report']">
<xsl:choose>
<xsl:when test="//jnl:article[@logo and contains(@logo , 'edchoice')] and not(//jnl:topic/node()) and not(//jnl:front/jnl:metadata)">
<xsl:element name="article-categories">
<xsl:element name="subj-group">
<xsl:attribute name="subj-group-type">
<xsl:text>hwp-journal-coll</xsl:text>
...
<xsl:when test="$SubTypeNum != '' and not(//jnl:topic/node()) and not(//jnl:front/jnl:metadata)">
<xsl:element name="article-categories">
<xsl:element name="subj-group">
<xsl:attribute name="subj-group-type">
<xsl:text>hwp-journal-coll</xsl:text>
...
<xsl:choose>
<xsl:when test="contains(jnl:meta-name/. , 'Ethnicity') or contains(jnl:meta-name/. , 'ETHNICITY') or contains(jnl:meta-name/. , 'ethnicity')">
<xsl:text>ethnicity</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:meta-name/. , 'Region') or contains(jnl:meta-name/. , 'REGION') or contains(jnl:meta-name/. , 'region')">
<xsl:text>region</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:meta-name/. , 'Sex') or contains(jnl:meta-name/. , 'SEX') or contains(jnl:meta-name/. , 'sex')">
<xsl:text>sex</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:meta-name/. , 'Age') or contains(jnl:meta-name/. , 'AGE') or contains(jnl:meta-name/. , 'age')">
<xsl:text>age</xsl:text>
</xsl:when>
</xsl:choose>
</xsl:attribute>
<xsl:apply-templates select="jnl:meta-value/node()"/>
</xsl:element>
</xsl:for-each>
</xsl:element>
...
<xsl:element name="subject">
<xsl:apply-templates select="//jnl:unit-info/jnl:categ/node()" mode="justchar"/>
</xsl:element>
</xsl:element>
</xsl:element>
</xsl:when>
<xsl:when test="//jnl:unit-info/jnl:rh-recto[. = 'Reviews' or . = 'Review']">
<xsl:element name="article-categories">
<xsl:element name="subj-group">
<xsl:attribute name="subj-group-type">
<xsl:text>heading</xsl:text>
...
<xsl:when test="//jnl:unit-info/jnl:rh-recto[. = 'Editorial' or . = 'Editorials']">
<xsl:element name="article-categories">
<xsl:element name="subj-group">
<xsl:attribute name="subj-group-type">
<xsl:text>heading</xsl:text>
...
<xsl:choose>
<xsl:when test="jnl:article and jnl:article/jnl:front/jnl:title-grp/jnl:title/node()">
<xsl:apply-templates select="jnl:article/jnl:front/jnl:title-grp/jnl:title/node()"/>
</xsl:when>
<xsl:when test="jnl:article-rev and jnl:article-rev/jnl:title-grp/jnl:title/node()">
<xsl:apply-templates select="jnl:article-rev/jnl:title-grp/jnl:title/node()"/>
</xsl:when>
<xsl:when test="//jnl:letter-grp and //jnl:letter/jnl:title/node()">
<xsl:apply-templates select="//jnl:letter/jnl:title/node()"/>
</xsl:when>
<xsl:when test="//jnl:book-rev and //jnl:book-desc/jnl:title/node()">
<xsl:apply-templates select="//jnl:book-desc/jnl:title/node()"/>
</xsl:when>
</xsl:choose>
</xsl:element>
<xsl:if test="jnl:article and jnl:article/jnl:front/jnl:title-grp/jnl:sub-tl/node()">
<xsl:if test="not(//jnl:bmj-module-no/. = '6')">
<xsl:choose>
<xsl:when test="//jnl:bmj-module-no/. = '5' and //jnl:jnl-info/jnl:abrv-jnl-tl = 'BHT'"/>
<xsl:otherwise>
<xsl:for-each select="jnl:article/jnl:front/jnl:title-grp/jnl:sub-tl">
...
<xsl:element name="contrib-group">
<xsl:apply-templates select="//jnl:author-grp[1]/node()[self::jnl:corresponding-author or self::jnl:author or self::jnl:corporate-author]"/>
</xsl:element>
<xsl:for-each select="//jnl:author-grp[1]">
<xsl:for-each select="jnl:aff | jnl:dept-list/jnl:dept">
<xsl:choose>
<xsl:when test="self::jnl:dept">
<xsl:if test="node() | jnl:hdr-txt/node() | jnl:org-name/node() | jnl:org-div/node() | jnl:address/node()[not(self::jnl:email)]/node()">
...
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl[. = 'DMF'  or . = 'dmf']">
<xsl:if test="@num and @num != ''">
...
<xsl:if test="parent::jnl:dept-list/jnl:hdr-txt/node()">
<xsl:apply-templates select="parent::jnl:dept-list/jnl:hdr-txt" mode="affs"/>
<xsl:text> </xsl:text>
</xsl:if>
<xsl:variable name="content">
<xsl:apply-templates />
...
<xsl:variable name="content2" select="substring($content, string-length($content) - 4 , 5)"/>
<xsl:choose>
<xsl:when test="$content2 = ', and'">
<xsl:value-of disable-output-escaping="yes" select="substring($content, 1, string-length($content) - 5)"/>
</xsl:when>
<xsl:otherwise>
<xsl:apply-templates />
</xsl:otherwise>
...
<xsl:if test="parent::jnl:dept-list/jnl:org-name/node()">
<xsl:text>, </xsl:text>
<xsl:apply-templates select="parent::jnl:dept-list/jnl:org-name" mode="affs"/>
</xsl:if>
</xsl:element>
<xsl:if test="parent::jnl:dept-list/jnl:address/jnl:street/node() | parent::jnl:dept-list/jnl:address/jnl:city/node() | parent::jnl:dept-list/jnl:address/jnl:state/node() | parent::jnl:dept-list/jnl:address/jnl:postcode/node() | parent::jnl:dept-list/jnl:address/jnl:postbox/node()">
<xsl:element name="addr-line">
<xsl:apply-templates select="parent::jnl:dept-list/jnl:address/jnl:street | parent::jnl:dept-list/jnl:address/jnl:city | parent::jnl:dept-list/jnl:address/jnl:state | parent::jnl:dept-list/jnl:address/jnl:postcode | parent::jnl:dept-list/jnl:address/jnl:postbox" mode="affs"/>
</xsl:element>
</xsl:if>
<xsl:if test="parent::jnl:dept-list/jnl:address/jnl:country/node()">
<xsl:element name="country">
<xsl:apply-templates select="parent::jnl:dept-list/jnl:address/jnl:country" mode="affs"/>
</xsl:element>
</xsl:if>
<xsl:if test="parent::jnl:dept-list/jnl:address/jnl:email/node()">
<xsl:apply-templates select="parent::jnl:dept-list/jnl:address/jnl:email" mode="affs"/>
</xsl:if>
</xsl:element>
</xsl:if>
</xsl:when>
<xsl:otherwise>
<xsl:if test="jnl:org-name/node() | jnl:org-div/node() | jnl:address/node()">
<xsl:variable name="Count">
<xsl:value-of select="substring-after(@id, 'aff')"/>
</xsl:variable>
<xsl:element name="aff">
...
<xsl:when test="count(//jnl:author-grp[not(jnl:corresponding-author)]/jnl:aff) &gt; 1 or //jnl:dept-list/jnl:dept">
<xsl:text disable-output-escaping="yes">&lt;label&gt;</xsl:text>
<xsl:value-of select="substring-after(@id, 'aff')"/>
<xsl:text disable-output-escaping="yes">&lt;/label&gt;</xsl:text>
</xsl:when>
...
<xsl:choose>
<xsl:when test="jnl:org-name/node() | jnl:org-div/node()">
<xsl:text disable-output-escaping="yes">&lt;institution&gt;</xsl:text>	
<xsl:apply-templates select="jnl:org-name | jnl:org-div" mode="affs"/>
<xsl:text disable-output-escaping="yes">&lt;/institution&gt;</xsl:text>	
<xsl:if test="jnl:address/node()[not(self::jnl:email or self::jnl:country)]">
<xsl:text disable-output-escaping="yes">, </xsl:text>	
<xsl:text disable-output-escaping="yes">&lt;addr-line&gt;</xsl:text>
<xsl:apply-templates select="jnl:address/node()[not(self::jnl:email or self::jnl:country)]" mode="affs"/>
<xsl:text disable-output-escaping="yes">&lt;/addr-line&gt;</xsl:text>
</xsl:if>
...
<xsl:apply-templates select="jnl:address/node()[not(self::jnl:email or self::jnl:country)]" mode="affs"/>
<xsl:text disable-output-escaping="yes">&lt;/addr-line&gt;</xsl:text>
<xsl:if test="jnl:address/jnl:country/node() or jnl:address/jnl:email/node()">
<xsl:text disable-output-escaping="yes">, </xsl:text>	
</xsl:if>
</xsl:if>
<xsl:if test="jnl:address/jnl:country/node()">
...
<xsl:if test="//jnl:biog[not(@type)]/node()[position() = 1 and self::text() and contains(self::text(), 'Action Editor')]">
<xsl:element name="contrib-group">
<xsl:apply-templates select="//jnl:biog[not(@type) and node()[position() = 1 and self::text() and contains(self::text(), 'Action Editor')]]" mode="contrib"/>
</xsl:element>
</xsl:if>
<xsl:choose>
<xsl:when test="//jnl:author-grp[jnl:editor]">
<xsl:element name="contrib-group">
<xsl:apply-templates select="//jnl:author-grp[jnl:editor]/node()[self::jnl:editor or self::jnl:corresponding-author]"/>
</xsl:element>
</xsl:when>
<xsl:when test="//jnl:author-grp[@type = 'editor']/jnl:author or //jnl:author-grp[@type = 'editor']/jnl:corresponding-author">
<xsl:element name="contrib-group">
<xsl:apply-templates select="//jnl:author-grp[@type = 'editor']/node()[self::jnl:author or self::jnl:corresponding-author]"/>
</xsl:element>
</xsl:when>
</xsl:choose>
<xsl:for-each select="//jnl:author-grp[jnl:editor or @type = 'editor']/jnl:aff | //jnl:author-grp[jnl:editor or @type = 'editor']/jnl:dept-list/jnl:dept">
<xsl:choose>
<xsl:when test="self::jnl:dept">
<xsl:if test="jnl:hdr-txt/node() | jnl:org-name/node() | jnl:org-div/node() | jnl:address/node()[not(self::jnl:email)]/node()">
<xsl:element name="aff">
<xsl:attribute name="id">
<xsl:text>edit</xsl:text><xsl:value-of select="substring-after(@id,'e')"/>
</xsl:attribute>
...
<xsl:if test="//jnl:section[@type = 'Contributions' or @type = 'MoreInfo'] | //jnl:front/jnl:note[@type = 'currentaddress'] | //jnl:corresponding-author[$CorresAuthor = '0'] | //jnl:footnote[ancestor::jnl:author-grp and ancestor::jnl:author] | //jnl:aff[$AffType = '1']/jnl:address/jnl:email/node() | //jnl:dept-list[$AffType = '1']/jnl:address/jnl:email/node()">
<xsl:element name="author-notes">
<xsl:apply-templates select="//jnl:section[@type = 'Contributions']" mode="contrib"/>
<xsl:apply-templates select="//jnl:front/jnl:note[@type = 'currentaddress']" mode="current"/>
<xsl:apply-templates select="//jnl:footnote[ancestor::jnl:author-grp]"/>
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl[. = 'BJR'  or . = 'bjr']">
<xsl:apply-templates select="//jnl:corresponding-author" mode="corrname"/>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl[. = 'DMF'  or . = 'dmf']">
<xsl:apply-templates select="//jnl:corresponding-author[parent::jnl:author-grp[not(jnl:author)]]" mode="corrname"/>
</xsl:when>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl[. = 'IMJ'  or . = 'imj']">
<xsl:apply-templates select="//jnl:corresponding-author" mode="corrname"/>
</xsl:when>
</xsl:choose>
	<xsl:choose>
	<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BIN'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bin'">
		<xsl:apply-templates select="//jnl:section[@type = 'MoreInfo']" mode="more"/>
	</xsl:when>
	<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'CES'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'ces'">		
	</xsl:when>
	</xsl:choose>
...
<xsl:attribute name="pub-type">ppub</xsl:attribute>
<xsl:element name="year"><xsl:apply-templates select="jnl:jnl-info/jnl:date/jnl:year/."/></xsl:element>
</xsl:element>
<xsl:element name="pub-date">
...
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'CES'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'ces'">
	<xsl:element name="pub-date">
		...
		<xsl:element name="day">
			<xsl:apply-templates select="jnl:jnl-info/jnl:date/jnl:day/."/>
		</xsl:element>
		<xsl:element name="month">
			<xsl:apply-templates select="jnl:jnl-info/jnl:date/jnl:month/."/>
		</xsl:element>
...
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BIN'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bin'">
	...
	<xsl:apply-templates select="jnl:article/jnl:front/jnl:history"/>
	</xsl:when>
...
<xsl:apply-templates select="//jnl:unit-info/jnl:cpyrt/jnl:date/jnl:year/."/>
<xsl:text> </xsl:text>
<xsl:apply-templates select="//jnl:unit-info/jnl:cpyrt/jnl:cpyrt-name/jnl:org-name/node()"/>
<xsl:text disable-output-escaping="yes">&lt;/copyright-statement&gt;</xsl:text>
<xsl:text disable-output-escaping="yes">&lt;copyright-year&gt;</xsl:text>
<xsl:apply-templates select="//jnl:unit-info/jnl:cpyrt/jnl:date/jnl:year/."/>
<xsl:text disable-output-escaping="yes">&lt;/copyright-year&gt;</xsl:text>
...
<xsl:attribute name="abstract-type"><xsl:text>teaser</xsl:text></xsl:attribute>
<xsl:for-each select="jnl:article/jnl:front/jnl:title-grp/jnl:sub-tl">
<xsl:element name="p">
<xsl:apply-templates />
</xsl:element>
...
<xsl:when test="jnl:correspondence">
<xsl:apply-templates select="//jnl:letter-grp/jnl:letter/jnl:keywd-grp"/>
</xsl:when>
</xsl:choose>
...
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'XXX' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'XXX'">
<xsl:choose>
<xsl:when test="//jnl:jnl-tl[. = 'BMJ Case Reports' or . = 'BMJ Case Report']"/>
<xsl:when test="//jnl:front/jnl:metadata">
...
<xsl:apply-templates select="jnl:news/jnl:p|jnl:news/jnl:news-section"/>
</xsl:when>
</xsl:choose>
</xsl:element>
<xsl:choose>
<xsl:when test="//jnl:news/jnl:refs | //jnl:footnote[not(ancestor::jnl:author-grp) and ancestor::jnl:news]">
...
<xsl:apply-templates select="//jnl:footnote[not(ancestor::jnl:author-grp)]" mode="backfoot"/>
</xsl:element>
</xsl:if>
</xsl:element>
</xsl:when>
...
<xsl:choose>
<xsl:when test="//jnl:front/jnl:note[@type = 'conflict'] | //jnl:grant/node() | //jnl:book-rev/jnl:refs | //jnl:letter/jnl:refs | jnl:article/jnl:front/jnl:abrv-grp | jnl:article//jnl:acks | jnl:article/jnl:back/jnl:refs  | jnl:article/jnl:apps/jnl:app | jnl:article/jnl:back/jnl:apps/jnl:app | //jnl:footnote[not(ancestor::jnl:author-grp)]">
<xsl:element name="back">                                                       
<xsl:if test="jnl:article//jnl:acks">
<xsl:element name="ack">
<xsl:apply-templates select="jnl:article//jnl:acks/node()"/>
                            
</xsl:element>
</xsl:if>
<xsl:apply-templates select="jnl:article/jnl:back/node()[self::jnl:refs | self::jnl:apps[jnl:app]]"/>
...
<xsl:apply-templates select="jnl:article/jnl:apps/jnl:app"/>
...
<xsl:element name="title"><xsl:text>Abbreviations</xsl:text></xsl:element>
<xsl:element name="def-list">
<xsl:apply-templates select="jnl:article/jnl:front/jnl:abrv-grp/jnl:abrv-item"/>
</xsl:element>
</xsl:element>
</xsl:if>
<xsl:if test="//jnl:front/jnl:note[@type = 'conflict'] | //jnl:grant/node() | //jnl:footnote[not(ancestor::jnl:author-grp)]">
<xsl:element name="fn-group">
<xsl:apply-templates select="//jnl:footnote[not(ancestor::jnl:author-grp)]" mode="backfoot"/>
<xsl:apply-templates select="//jnl:front/jnl:note[@type = 'conflict']" mode="conflict"/>
<xsl:apply-templates select="//jnl:grant[node()]" mode="footgrant"/>
</xsl:element>
</xsl:if>
</xsl:element>
</xsl:when>
...
<xsl:when test="//jnl:section[@type = 'ConflictingInterests' or @type = 'Funding' or @type = 'PPR' or @type = 'CompetingInterests'] | //jnl:book-rev/jnl:refs | //jnl:letter/jnl:refs | jnl:article/jnl:front/jnl:abrv-grp | jnl:article//jnl:acks | jnl:article/jnl:back/node()[self::jnl:refs | self::jnl:apps]  | jnl:article/jnl:apps/jnl:app | //jnl:footnote[not(ancestor::jnl:author-grp)]">
<xsl:element name="back">                                                       
<xsl:if test="jnl:article//jnl:acks">
<xsl:element name="ack">
<xsl:apply-templates select="jnl:article//jnl:acks/node()"/>
...
<xsl:choose>
<xsl:when test="//jnl:jnl-tl[. = 'BMJ Case Reports' or . = 'BMJ Case Report']">
<xsl:if test="//jnl:section[@type = 'ConflictingInterests' or @type = 'Funding' or @type = 'PPR' or @type = 'CompetingInterests' or @type = 'PatientConsent'] | //jnl:footnote[not(ancestor::jnl:author-grp)]">
<xsl:element name="fn-group">
<xsl:if test="//jnl:section[@type = 'ConflictingInterests' or @type = 'Funding' or @type = 'PPR' or @type = 'CompetingInterests']">
<xsl:for-each select="//jnl:section[@type = 'CompetingInterests']">
...
<xsl:for-each select="//jnl:section[@type = 'ConflictingInterests']">
<xsl:for-each select="jnl:p">
<xsl:element name="fn">
<xsl:text disable-output-escaping="yes">&lt;p&gt;</xsl:text>
<xsl:text disable-output-escaping="yes">&lt;bold&gt;</xsl:text>
...
<xsl:for-each select="//jnl:section[@type = 'Funding']">
<xsl:for-each select="jnl:p">
<xsl:element name="fn">
<xsl:text disable-output-escaping="yes">&lt;p&gt;</xsl:text>
<xsl:text disable-output-escaping="yes">&lt;bold&gt;</xsl:text>
...
<xsl:for-each select="//jnl:section[@type = 'PPR']">
<xsl:for-each select="jnl:p">
<xsl:element name="fn">
<!--
<xsl:attribute name="fn-type">
...
<xsl:for-each select="//jnl:section[@type = 'PatientConsent']">
<xsl:for-each select="jnl:p">
<xsl:element name="fn">
<xsl:text disable-output-escaping="yes">&lt;p&gt;</xsl:text>
<xsl:text disable-output-escaping="yes">&lt;bold&gt;</xsl:text>
...
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BAM'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bam'">
<xsl:if test="//jnl:section[@type = 'ConflictingInterests' or @type = 'MoreInfo' or @type = 'Funding' or @type = 'PPR' or @type = 'EthicsApproval'] | //jnl:footnote[not(ancestor::jnl:author-grp)]">
<xsl:element name="fn-group">
<xsl:if test="//jnl:section[@type = 'ConflictingInterests' or @type = 'Funding' or @type = 'PPR' or @type = 'EthicsApproval']">
<xsl:for-each select="//jnl:section[@type = 'ConflictingInterests']">
<xsl:for-each select="jnl:p">
<xsl:element name="fn">
<xsl:text disable-output-escaping="yes">&lt;p&gt;</xsl:text>
...
<xsl:for-each select="//jnl:section[@type = 'EthicsApproval']">
<xsl:for-each select="jnl:p">
<xsl:element name="fn">
<xsl:text disable-output-escaping="yes">&lt;p&gt;</xsl:text>
...
<xsl:otherwise>
<xsl:if test="//jnl:section[@type = 'ConflictingInterests' or @type = 'CompetingInterests' or @type = 'Funding' or @type = 'PPR'] | //jnl:footnote[not(ancestor::jnl:author-grp)]">
<xsl:element name="fn-group">
<xsl:if test="//jnl:section[@type = 'ConflictingInterests' or @type = 'CompetingInterests' or @type = 'Funding' or @type = 'PPR']">
<xsl:for-each select="//jnl:section[@type = 'CompetingInterests']">
<xsl:for-each select="jnl:p">
<xsl:element name="fn">
<xsl:attribute name="fn-type">
...
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'CES'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'ces'">
	<xsl:if test="//jnl:section[@type = 'MoreInfo'] or //jnl:section[@type = 'SupplementaryMaterial']">
	<xsl:element name="fn-group">
	<xsl:apply-templates select="//jnl:section[@type = 'MoreInfo']" mode="moreCES"/>
	<xsl:apply-templates select="//jnl:section[@type = 'SupplementaryMaterial']" mode="supplementaryMaterial"/>
	</xsl:element>
	</xsl:if>
</xsl:when>
</xsl:choose>
...
<xsl:for-each select="//jnl:article/jnl:body/jnl:section[@type and @type = 'TextBox']">
<xsl:choose>
...
<xsl:value-of select="substring-before($doitext,'/cr.')"/>	
<xsl:text>/bcr.</xsl:text>
<xsl:value-of select="substring-after($doitext,'/cr.')"/>	
</xsl:when>
...
<xsl:value-of select="substring-before($doitext,'/am.')"/>	
<xsl:text>/acupmed.</xsl:text>
<xsl:value-of select="substring-after($doitext,'/am.')"/>	
</xsl:when>
<xsl:when test="contains($doitext , '/aim.')">
<xsl:value-of select="substring-before($doitext,'/aim.')"/>	
<xsl:text>/acupmed.</xsl:text>
<xsl:value-of select="substring-after($doitext,'/aim.')"/>	
</xsl:when>
...
<xsl:choose>
<xsl:when test="//jnl:unit-info[1]/node()[self::jnl:categ]/node()">
<xsl:element name="article-categories">
<xsl:element name="subj-group">
<xsl:attribute name="subj-group-type">
<xsl:text>heading</xsl:text>
...
<xsl:element name="subject">
<xsl:choose>
<xsl:when test="//jnl:unit-info[1]/jnl:categ[text()[contains(. , 'article')] and text()[contains(. , 'research')]]">
<xsl:text>Research Articles</xsl:text>
</xsl:when>
<xsl:when test="//jnl:unit-info[1]/jnl:categ[text()[contains(. , 'article')] and text()[contains(. , 'research')]]">
<xsl:text>Research Articles</xsl:text>
</xsl:when>
<xsl:when test="//jnl:unit-info/jnl:categ/node() = 'EXTENDED REPORT'">
<xsl:text>Extended report</xsl:text>
</xsl:when>
<xsl:when test="//jnl:unit-info/jnl:categ/node() = 'Extended Report'">
<xsl:text>Extended report</xsl:text>
</xsl:when>
<xsl:when test="//jnl:unit-info[1]/jnl:categ/node() = 'Articles'">
<xsl:text>Research Articles</xsl:text>
</xsl:when>
<xsl:when test="//jnl:unit-info[1]/jnl:categ/node() = 'ARTICLES'">
<xsl:text>Research Articles</xsl:text>
</xsl:when>
<xsl:when test="//jnl:unit-info[1]/jnl:categ/node() = 'Article'">
<xsl:text>Research Articles</xsl:text>
</xsl:when>
<xsl:when test="//jnl:unit-info[1]/jnl:categ/node() = 'ARTICLE'">
<xsl:text>Research Articles</xsl:text>
...
<xsl:otherwise>
<xsl:apply-templates select="//jnl:unit-info[1]/jnl:categ/node()" mode="sentence"/>
</xsl:otherwise>
</xsl:choose>
</xsl:element>
</xsl:element>
...
<xsl:if test="jnl:section[@type= 'Author']/jnl:p[processing-instruction('Author')]">
<xsl:element name="contrib-group">
<xsl:for-each select="jnl:section[@type= 'Author']/jnl:p[processing-instruction('Author')]">
<xsl:choose>
...
<xsl:otherwise>
<xsl:variable name="Content" select="."/>
<xsl:variable name="normal-string" select="normalize-space($Content)"/>
<xsl:choose>
<xsl:when test="$normal-string != ''">
<xsl:variable name="first" select="normalize-space(substring-before($normal-string,','))"/>
<xsl:variable name="rest" select="normalize-space(substring-after($normal-string,','))"/>
<xsl:choose>
<xsl:when test="$first != ''">
<xsl:element name="contrib">
<xsl:attribute name="contrib-type">author</xsl:attribute>
<xsl:text disable-output-escaping="yes">&lt;name&gt;</xsl:text>
<xsl:variable name="normal-sstring" select="normalize-space($first)"/>
<xsl:choose>
<xsl:when test="$normal-sstring != ' '">				
<xsl:variable name="s1first" select="normalize-space(substring-before($normal-sstring,' '))"/>	
<xsl:variable name="s1rest" select="normalize-space(substring-after($normal-sstring,' '))"/>	
<xsl:if test="$s1first = 'Professor' or $s1first = 'professor' or $s1first = 'Prof' or $s1first = 'Dr' or $s1first = 'Doctor'">
<nomen>
...
<xsl:choose>
<xsl:when test="$s1first = 'Professor' or $s1first = 'professor' or $s1first = 'Prof' or $s1first = 'Dr' or $s1first = 'Doctor'">
<xsl:value-of select="normalize-space(substring-before($s1rest,' '))"/>	
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="normalize-space(substring-before($normal-sstring,' '))"/>	
</xsl:otherwise>
</xsl:choose>
</xsl:variable>	
...
<xsl:choose>
<xsl:when test="$s1first = 'Professor' or $s1first = 'professor' or $s1first = 'Prof' or $s1first = 'Dr' or $s1first = 'Doctor'">
<xsl:value-of select="normalize-space(substring-after($s1rest,' '))"/>	
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="normalize-space(substring-after($normal-sstring,' '))"/>	
</xsl:otherwise>
</xsl:choose>
</xsl:variable>	
<xsl:choose>
<xsl:when test="$s2first != ''">
<xsl:variable name="ssecond" select="normalize-space(substring-before($s2rest,' '))"/>	
<xsl:variable name="srests" select="normalize-space(substring-after($s2rest,' '))"/>	
<xsl:choose>
...
<xsl:otherwise>
<xsl:text disable-output-escaping="yes">&lt;surname&gt;</xsl:text>
<xsl:value-of select="normalize-space($normal-sstring)"/>
<xsl:text disable-output-escaping="yes">&lt;/surname&gt;</xsl:text>
</xsl:otherwise>
</xsl:choose>
</xsl:when>
...
<xsl:attribute name="contrib-type">author</xsl:attribute>
<xsl:text disable-output-escaping="yes">&lt;name&gt;</xsl:text>
<xsl:variable name="normal-sstring" select="normalize-space($normal-string)"/>
<xsl:choose>
<xsl:when test="$normal-sstring != ' '">				
<xsl:variable name="s1first" select="normalize-space(substring-before($normal-sstring,' '))"/>	
<xsl:variable name="s1rest" select="normalize-space(substring-after($normal-sstring,' '))"/>	
...
<xsl:if test="jnl:section[@type= 'Author']/jnl:p[processing-instruction('Address')]">
<xsl:if test="jnl:section[@type= 'Author']/jnl:p[processing-instruction('Author')]">
<xsl:call-template name="newline"/>
</xsl:if>
<xsl:for-each select="jnl:section[@type= 'Author']/jnl:p[processing-instruction('Address')]">
<xsl:choose>
<xsl:when test="not(preceding-sibling::node()[position() = 1 and self::jnl:p[processing-instruction('Address')]])">
<xsl:variable name="c1count" select="count(//jnl:author-grp[jnl:author]/jnl:aff)"/>
<xsl:variable name="c2count" select="count(preceding-sibling::jnl:p[processing-instruction('Address') and not(preceding-sibling::node()[position() = 1 and self::jnl:p[processing-instruction('Address')]])])"/>
...
<xsl:text disable-output-escaping="yes">&lt;/institution&gt;</xsl:text>
<xsl:choose>
<xsl:when test="not(following-sibling::node()[position() = 1 and self::jnl:p[processing-instruction('Address')]])">
<xsl:text disable-output-escaping="yes">&lt;/aff&gt;</xsl:text>
<xsl:call-template name="newline"/>
</xsl:when>
</xsl:choose>
</xsl:when>
<xsl:when test="not(preceding-sibling::node()[position() = 2 and self::jnl:p[processing-instruction('Address')]])">
<xsl:text disable-output-escaping="yes">&lt;addr-line&gt;</xsl:text>
<xsl:apply-templates />
<xsl:choose>
<xsl:when test="not(following-sibling::node()[position() = 1 and self::jnl:p[processing-instruction('Address')]])">
...
<xsl:apply-templates select="jnl:section[not(@type = 'MoreInfo' or @type = 'Author')]"/>
<!--</xsl:element>-->
</xsl:element>
</xsl:element>
</xsl:when>
...
<xsl:attribute name="id"><xsl:text>s1</xsl:text></xsl:attribute>
<xsl:attribute name="sec-type"><xsl:text>intro</xsl:text></xsl:attribute>
<xsl:element name="title">
</xsl:element>
<xsl:apply-templates/>
</xsl:element>
...
<xsl:when test="$CustCode = 'jaba' or $CustCode = 'jeab' or //jnl:jnl-info/jnl:medline-jnl-tl/. != ''"> 
<xsl:element name="journal-id">
<xsl:attribute name="journal-id-type">nlm-ta</xsl:attribute>
<xsl:choose>
...
<xsl:element name="article-id">
<xsl:attribute name="pub-id-type">publisher-id</xsl:attribute>
<xsl:apply-templates select="//jnl:article-rev/jnl:unit-info/jnl:c-tracker-id/."/>
</xsl:element>
<xsl:element name="article-id">
<xsl:attribute name="pub-id-type">doi</xsl:attribute>
...
<xsl:value-of disable-output-escaping="yes" select="translate($contt , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:variable>
<xsl:choose>
<xsl:when test="starts-with($contal , '&amp;')">
<xsl:value-of disable-output-escaping="yes" select="$contal"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of disable-output-escaping="yes" select="translate(substring($contal, 1 , 1), 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
<xsl:value-of disable-output-escaping="yes" select="substring($contal, 2)"/>
</xsl:otherwise>
</xsl:choose>
</xsl:element>
</xsl:element>
...
<xsl:element name="year">
<xsl:choose>
<xsl:when test="//jnl:misc-date[jnl:date-text/text()[contains(. , 'online') or contains(. , 'ONLINE') or contains(. , 'Online')]]/jnl:year">
<xsl:apply-templates select="//jnl:misc-date[jnl:date-text/text()[contains(. , 'online') or contains(. , 'ONLINE') or contains(. , 'Online')]]/jnl:year/."/>
</xsl:when>
<xsl:otherwise>
<xsl:apply-templates select="//jnl:jnl-info/jnl:date/jnl:year/."/>
</xsl:otherwise>
...
<xsl:element name="pub-date">
<xsl:attribute name="pub-type">ppub</xsl:attribute>
<xsl:element name="month"><xsl:value-of select="$EEMonth"/></xsl:element>
<xsl:element name="year"><xsl:apply-templates select="//jnl:jnl-info/jnl:date/jnl:year/."/></xsl:element>
</xsl:element>
<xsl:choose>
<xsl:when test="//jnl:misc-date/jnl:date-text/text()[contains(. , 'online') or contains(. , 'ONLINE') or contains(. , 'Online')]">
<xsl:element name="pub-date">
<xsl:attribute name="pub-type">epub</xsl:attribute>
<xsl:apply-templates select="//jnl:misc-date[jnl:date-text/text()[contains(. , 'online') or contains(. , 'ONLINE') or contains(. , 'Online')]]/jnl:date"/>
</xsl:element>
</xsl:when>
</xsl:choose>
</xsl:otherwise>
...
<xsl:text disable-output-escaping="yes">&amp;copy; </xsl:text>
<xsl:choose>
<xsl:when test="//jnl:author-grp[jnl:author or jnl:corporate-author or jnl:editor or jnl:corresponding-author]">
<xsl:for-each select="//jnl:author-grp[jnl:author or jnl:corporate-author or jnl:editor or jnl:corresponding-author]">
<xsl:choose>
<xsl:when test="preceding::jnl:author-grp[jnl:author or jnl:corporate-author or jnl:editor or jnl:corresponding-author]"/>
<xsl:otherwise>
<xsl:for-each select="node()">
<xsl:choose>
<xsl:when test="preceding-sibling::node()[self::jnl:author or self::jnl:corporate-author or jnl:editor or jnl:corresponding-author]"/>
<xsl:when test="preceding::jnl:author-grp[jnl:author or jnl:corporate-author or jnl:editor or jnl:corresponding-author]"/>
...
<xsl:choose>
<xsl:when test="following-sibling::node()[self::jnl:author or self::jnl:corporate-author or jnl:editor]">
<xsl:text> et al</xsl:text>
</xsl:when>
<xsl:when test="preceding::jnl:author-grp[jnl:author or jnl:corporate-author or jnl:editor]">
<xsl:text> et al</xsl:text>
</xsl:when>
</xsl:choose>
</xsl:otherwise>
...
<xsl:element name="sec">
<xsl:attribute name="id"><xsl:text>s</xsl:text><xsl:value-of select="$subsect"/>
</xsl:attribute>
<xsl:attribute name="sec-type"><xsl:text>cases</xsl:text></xsl:attribute>
<xsl:element name="title">
</xsl:element>
...
<xsl:attribute name="list-type"><xsl:value-of select="$list-type"/></xsl:attribute>
<xsl:apply-templates />
</xsl:element>
</xsl:element>
</xsl:when>
...
<xsl:variable name="fids"><xsl:value-of select="@rids"/></xsl:variable>
<xsl:variable name="fidused">
...
<xsl:variable name="ReferNo"><xsl:value-of select="@rids"/></xsl:variable>
...
<xsl:variable name="Number2" select="count(preceding-sibling::jnl:app)"/>
<xsl:choose>
...
<xsl:template match="jnl:refs[ancestor::jnl:back] | jnl:refs[ancestor::jnl:letter] | jnl:refs[ancestor::jnl:abstract[parent::jnl:doc]]">
<xsl:element name="ref-list">
<xsl:apply-templates/>
</xsl:element>
</xsl:template>
...
<xsl:if test="jnl:address/jnl:street/node() | jnl:address/jnl:city/node() | jnl:address/jnl:postbox/node() | jnl:address/jnl:state/node() | jnl:address/jnl:postcode/node() | jnl:address/jnl:postbox/node()">
<xsl:element name="addr-line">
<xsl:apply-templates select="jnl:address/jnl:street | jnl:address/jnl:city | jnl:address/jnl:state | jnl:address/jnl:postbox | jnl:address/jnl:postcode | jnl:address/jnl:postbox" mode="affs"/>
</xsl:element>
</xsl:if>
<xsl:if test="jnl:address/jnl:country/node()">
<xsl:element name="country">
...
<xsl:template match="jnl:cit[ancestor::jnl:back | ancestor::jnl:letter | ancestor::jnl:book-rev | ancestor::jnl:news | ancestor::jnl:abstract[parent::jnl:doc]]">
<xsl:element name="ref">
<xsl:attribute name="id">
<xsl:text>b</xsl:text>
<xsl:variable name="Number"><xsl:value-of select="substring-after(@id,'ref')"/></xsl:variable>
...
<xsl:value-of select="translate($partA , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
...
<xsl:element name="ref">
<xsl:attribute name="id">
<xsl:text>nr</xsl:text><xsl:value-of select="substring-after(@id,'noteref')"/>
</xsl:attribute>
...
<xsl:when test="preceding-sibling::node()[position() = 1 and self::text()] and preceding-sibling::node()[position() = 2 and self::jnl:author]"/>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::text()] and preceding-sibling::node()[position() = 2 and self::jnl:etal]"/>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::text()] and preceding-sibling::node()[position() = 2 and self::jnl:editor]"/>
<xsl:otherwise>
...
<xsl:when test="following-sibling::node()[not(self::text() or self::jnl:emph or self::processing-instruction())]">
<xsl:text> </xsl:text>
</xsl:when>
<xsl:otherwise>
<xsl:text></xsl:text>
...
<xsl:when test="following-sibling::node()[position() = 1 and self::text()] and following-sibling::node()[position() = 2 and self::jnl:etal]"/>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::jnl:editor]">
<xsl:text disable-output-escaping="yes">&lt;/person-group&gt;</xsl:text>
<xsl:text>, eds. </xsl:text>
</xsl:when>
...
<xsl:choose>
<xsl:when test="jnl:surname | jnl:initial | jnl:forename | jnl:ac-degree | jnl:americanism | jnl:role">
<xsl:text>
</xsl:text>
</xsl:when>
</xsl:choose>
...
<xsl:when test="following-sibling::node()[position() = 1 and self::jnl:etal]"/>
<xsl:when test="following-sibling::node()[position() = 1 and self::text()] and following-sibling::node()[position() = 2 and self::jnl:editor]"/>
<xsl:when test="following-sibling::node()[position() = 1 and self::text()] and following-sibling::node()[position() = 2 and self::jnl:etal]"/>
<xsl:otherwise>
<xsl:call-template name="newline"/>
<xsl:text disable-output-escaping="yes">&lt;/person-group&gt;</xsl:text>
...
<xsl:apply-templates select="ancestor::jnl:article/jnl:unit-info/jnl:c-tracker-id/."/>
</xsl:when>
<xsl:when test="ancestor::jnl:article-rev">
<xsl:apply-templates select="ancestor::jnl:article-rev/jnl:unit-info/jnl:c-tracker-id/."/>
</xsl:when>
<xsl:when test="ancestor::jnl:letter-grp">
<xsl:apply-templates select="ancestor::jnl:letter-grp/jnl:unit-info/jnl:c-tracker-id/."/>
</xsl:when>
</xsl:choose>
<xsl:text>-</xsl:text>
<xsl:choose>
...
<xsl:variable name="Number" select="count(preceding::jnl:art-desc/jnl:author[1][jnl:surname/. = $Name]) + count(preceding::jnl:art-desc[jnl:editor and not(jnl:author)]/jnl:editor[1][jnl:surname/. = $Name])+ 1"/>
<xsl:value-of select="$Number"/>
</xsl:when>
...
<xsl:apply-templates select="jnl:author|jnl:etal[preceding-sibling::node()[position() = 1 and self::jnl:author]]"/>
</xsl:element>
</xsl:if>
...
<xsl:apply-templates select="jnl:editor|jnl:etal[preceding-sibling::node()[position() = 1 and self::jnl:editor]]"/>
</xsl:element>
</xsl:if>
...
<xsl:if test="jnl:surname | jnl:initial | jnl:forename | jnl:ac-degree | jnl:americanism | jnl:role">
<xsl:text disable-output-escaping="yes">&lt;name&gt;</xsl:text>
<xsl:if test="jnl:surname">
<xsl:text disable-output-escaping="yes">&lt;surname&gt;</xsl:text>
<xsl:apply-templates select="jnl:surname/."/>
...
<xsl:choose>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::jnl:editor] and parent::jnl:cit and not(parent::jnl:cit/jnl:pub-tl)">
...
<xsl:when test="preceding-sibling::node()[position() = 1 and self::jnl:editor] and parent::jnl:cit">
<xsl:text disable-output-escaping="yes">&lt;comment&gt;</xsl:text>
<xsl:apply-templates />
<xsl:text disable-output-escaping="yes">&lt;/comment&gt; </xsl:text>
</xsl:when>
<xsl:when test="following-sibling::node()[position() = 1 and self::jnl:editor] and parent::jnl:cit">
<xsl:text disable-output-escaping="yes">&lt;comment&gt;</xsl:text>
<xsl:apply-templates />
<xsl:text disable-output-escaping="yes">&lt;/comment&gt; </xsl:text>
</xsl:when>
...
<xsl:choose>
<xsl:when test="not(parent::jnl:cit/jnl:pub-name) and not(parent::jnl:cit/jnl:pub-tl) and processing-instruction('ENTCHAR')[. = 'colon']">
<xsl:text disable-output-escaping="yes">&lt;source&gt;</xsl:text>
<xsl:for-each select="node()">
<xsl:choose>
<xsl:when test="self::text() and preceding-sibling::node()[position() = 1 and self::processing-instruction('ENTCHAR')[. = 'colon']]">
<xsl:choose>
...
<xsl:when test="self::text() and preceding-sibling::processing-instruction('ENTCHAR')[. = 'colon']">
<xsl:value-of select="."/>
</xsl:when>
<xsl:when test="preceding-sibling::processing-instruction('ENTCHAR')[. = 'colon']">
<xsl:apply-templates select="self::node()"/>
</xsl:when>
...
<xsl:when test="parent::jnl:date/following-sibling::node()[position() = 1 and self::jnl:vol]">
<xsl:text>;</xsl:text>
</xsl:when>
<xsl:when test="parent::jnl:date/following-sibling::node()[position() = 1 and self::jnl:pages]">
<xsl:text>:</xsl:text>
</xsl:when>
...
<xsl:if test="preceding-sibling::jnl:ac-degree or preceding-sibling::jnl:americanism or preceding-sibling::jnl:role">
<xsl:text>, </xsl:text>
</xsl:if>
<xsl:apply-templates />
</xsl:template> 
...
<xsl:variable name="fid"><xsl:value-of select="@rids"/></xsl:variable>
...
<xsl:variable name="corr" select="translate($partA , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
<xsl:choose>
...
<xsl:apply-templates select="jnl:emph[@type and @type = 'sup']/node()"/>
</xsl:variable>
...
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'DMF' or //jnl:jnl-info/jnl:abrv-jnl-tl = 'dmf'">
<xsl:choose>
<xsl:when test="following-sibling::jnl:aff or following-sibling::jnl:dept-list/jnl:dept">
<xsl:choose>
<xsl:when test="parent::jnl:author-grp/jnl:author[@affs and @affs != ''] or parent::jnl:author-grp/jnl:corresponding-author[@affs and @affs != '']">
</xsl:when>
<xsl:otherwise>
<xsl:apply-templates select="following-sibling::jnl:aff" mode="Refers"/>
<xsl:apply-templates select="following-sibling::jnl:dept-list/jnl:dept" mode="Refers"/>
</xsl:otherwise>
</xsl:choose>
</xsl:when>
</xsl:choose>
...
<xsl:value-of disable-output-escaping="yes" select="substring-before($Chars,' ')"/>
</xsl:variable>
<xsl:variable name="rest">
<xsl:value-of disable-output-escaping="yes" select="substring-after($Chars,' ')"/>
</xsl:variable>
<xsl:choose>
...
<xsl:value-of disable-output-escaping="yes" select="substring($first,1,$fsize)"/>
</xsl:variable>
...
<xsl:value-of disable-output-escaping="yes" select="substring-before($rest,' ')"/>
</xsl:variable>
<xsl:variable name="lsize">
...
<xsl:value-of disable-output-escaping="yes" select="substring($first1,1,$fsize)"/>
</xsl:variable>
<xsl:call-template name="write-content">
...
<xsl:value-of disable-output-escaping="yes" select="substring-after($rest,' ')"/>
</xsl:variable>
<xsl:if test="$rest2 != ''">
<xsl:call-template name="splitcorrs">
...
<xsl:when test="$Tto = '.' or $Tto = ',' or $Tto = ';'">
<xsl:variable name="first2">
<xsl:value-of disable-output-escaping="yes" select="substring($Chars,1,$fsize)"/>
</xsl:variable>
<xsl:call-template name="write-content">
<xsl:with-param name="value" select="$first2"/>
</xsl:call-template>
...
<xsl:if test="jnl:org-name/node() | jnl:org-div/node() | jnl:address/node()[not(self::jnl:email)]/node()">
...
<xsl:if test="@num and @num != ''">
<xsl:text disable-output-escaping="yes">&lt;sup&gt;</xsl:text><xsl:apply-templates select="@num"/><xsl:text disable-output-escaping="yes">&lt;/sup&gt;</xsl:text>
</xsl:if>
</xsl:element>
</xsl:if>
</xsl:when>
...
<xsl:value-of select="count(preceding-sibling::jnl:aff[jnl:address/jnl:email/node()])"/>
</xsl:when>
<xsl:otherwise>
<xsl:text>0</xsl:text>
</xsl:otherwise>
...
<xsl:template match="jnl:dept[parent::jnl:dept-list and ancestor::jnl:author-grp]" mode="Refersemail">
<xsl:variable name="CorAuthors">
<xsl:choose>
<xsl:when test="//jnl:corresponding-author">
<xsl:value-of select="count(//jnl:corresponding-author)"/>
...
<xsl:attribute name="id"><xsl:text>n</xsl:text><xsl:value-of select="$CorAuthors + $Authemail + 101"/></xsl:attribute>
...
<xsl:template match="jnl:forename[ancestor::jnl:author-grp and parent::jnl:corresponding-author]">
<xsl:if test="preceding-sibling::node()">
<xsl:text> </xsl:text>
</xsl:if>
<xsl:apply-templates />
</xsl:template> 
<xsl:template match="jnl:forename[ancestor::jnl:author-grp and parent::jnl:corresponding-author]" mode="getname">
<xsl:apply-templates />
</xsl:template> 
<xsl:template match="jnl:ac-degree[ancestor::jnl:author-grp and parent::jnl:corresponding-author]">
<xsl:if test="preceding-sibling::node()">
<xsl:text>, </xsl:text>
</xsl:if>
<xsl:apply-templates />
...
<xsl:template match="jnl:americanism[ancestor::jnl:author-grp and parent::jnl:corresponding-author]">
<xsl:if test="preceding-sibling::node()">
<xsl:text>, </xsl:text>
</xsl:if>
<xsl:apply-templates />
...
<xsl:when test="@type='bold' and parent::tbl:title[parent::tbl:table] and //jnl:jnl-info/jnl:abrv-jnl-tl = 'BIN'">
<xsl:apply-templates />
</xsl:when>
...
<xsl:when test="@type='bold'">
<xsl:text disable-output-escaping="yes">&lt;bold&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/bold&gt;</xsl:text>
</xsl:when>
<xsl:when test="@type='underline'">
<xsl:text disable-output-escaping="yes">&lt;underline&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/underline&gt;</xsl:text>
</xsl:when>
<xsl:when test="@type='italic' and parent::jnl:p[@type = 'genus-normal-para' or @type = 'genus-small-para']">
<xsl:text disable-output-escaping="yes">&lt;named-content content-type="genus-species"&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/named-content&gt;</xsl:text>
</xsl:when>
<xsl:when test="@type='italic' and parent::jnl:p[@type = 'genus-centre']">
<xsl:text disable-output-escaping="yes">&lt;named-content content-type="genus"&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/named-content&gt;</xsl:text>
</xsl:when>
...
<xsl:when test="@type='italic'">
<xsl:choose>
<xsl:when test="ancestor::jnl:othinfo[preceding-sibling::node()[position() = 1 and self::jnl:editor] and parent::jnl:cit and not(parent::jnl:cit/jnl:pub-tl)]">
<xsl:apply-templates/>
</xsl:when>
<xsl:otherwise>
<xsl:text disable-output-escaping="yes">&lt;italic&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/italic&gt;</xsl:text>
</xsl:otherwise>
</xsl:choose>
</xsl:when>
<xsl:when test="@type='bold-italic'">
...
<xsl:otherwise>
<xsl:text disable-output-escaping="yes">&lt;bold&gt;&lt;italic&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/italic&gt;&lt;/bold&gt;</xsl:text>
</xsl:otherwise>
</xsl:choose>
</xsl:when>
<xsl:when test="@type='bold_italic'">
...
<xsl:otherwise>
<xsl:text disable-output-escaping="yes">&lt;sc&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/sc&gt;</xsl:text>
</xsl:otherwise>
</xsl:choose>
</xsl:when>
<xsl:when test="@type='sup'">
<xsl:text disable-output-escaping="yes">&lt;sup&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/sup&gt;</xsl:text>
</xsl:when>
<xsl:when test="@type='inf'">
<xsl:text disable-output-escaping="yes">&lt;sub&gt;</xsl:text><xsl:apply-templates/><xsl:text disable-output-escaping="yes">&lt;/sub&gt;</xsl:text>
</xsl:when>
<xsl:otherwise>
<xsl:apply-templates/>
</xsl:otherwise>
...
<xsl:template match="jnl:surname[ancestor::jnl:author-grp and parent::jnl:corresponding-author]" mode="getname">
<xsl:apply-templates />
</xsl:template>      
...
<xsl:element name="abstract">
<xsl:attribute name="abstract-type"><xsl:text>precis</xsl:text></xsl:attribute>
<xsl:apply-templates />
</xsl:element>
...
<xsl:element name="p">
<xsl:attribute name="content-type"><xsl:text>syn_centre</xsl:text></xsl:attribute>
<xsl:apply-templates />
</xsl:element>
</xsl:template>
...
<xsl:element name="p">
<xsl:attribute name="content-type"><xsl:text>syn_left</xsl:text></xsl:attribute>
<xsl:apply-templates />
</xsl:element>
</xsl:template>
<xsl:template match="jnl:p[@type = 'genus-hang']" priority="2">
<xsl:element name="p">
<xsl:attribute name="content-type"><xsl:text>syn_hang</xsl:text></xsl:attribute>
<xsl:if test="@num and @num != ''">
<xsl:apply-templates select="@num"/>
<xsl:if test="node()">
<xsl:text> </xsl:text>
...
<xsl:element name="p">
<xsl:attribute name="content-type"><xsl:text>syn_hang_small</xsl:text></xsl:attribute>
<xsl:apply-templates />
</xsl:element>
</xsl:template>
<xsl:template match="jnl:p[@type = 'genus-indent']" priority="2">
<xsl:element name="p">
<xsl:attribute name="content-type"><xsl:text>syn_indent</xsl:text></xsl:attribute>
<xsl:apply-templates />
</xsl:element>
</xsl:template>
...
<xsl:variable name="part1"><xsl:apply-templates mode="justchar"/></xsl:variable>
<xsl:variable name="part2">
<xsl:value-of select="translate($part1 , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:variable>
...
<xsl:for-each select="node()">
<xsl:choose>
<xsl:when test="following-sibling::jnl:emph[@type and @type = 'italic']">
<xsl:apply-templates select="self::node()"/>
</xsl:when>
<xsl:when test="self::jnl:emph[@type and @type = 'italic']">
<xsl:text disable-output-escaping="yes">&lt;uri xlink:href="</xsl:text>
<xsl:apply-templates select="following-sibling::jnl:url/node()" mode="justcharr"/>
<xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
<xsl:apply-templates select="self::node()" mode="justchar"/>
</xsl:when>
<xsl:when test="self::jnl:url"/>
<xsl:when test="self::jnl:emph">
<xsl:apply-templates select="self::node()" mode="justchar"/>
</xsl:when>
<xsl:when test="self::text() and following-sibling::node()[position() = 1 and self::jnl:url]">
<xsl:variable name="content" select="."/>
<xsl:choose>
...
<xsl:for-each select="node()">
<xsl:choose>
<xsl:when test="following-sibling::node()[self::text()[contains(. , '.')] and following-sibling::node()[position() = 1 and self::processing-instruction('ENTCHAR')[. = 'semi']]]">
<xsl:apply-templates select="self::node()"/>
</xsl:when>
<xsl:when test="self::text()[contains(. , '.')] and following-sibling::node()[position() = 1 and self::processing-instruction('ENTCHAR')[. = 'semi']]">
...
<xsl:apply-templates select="node()[not(self::jnl:section) or self::jnl:section[not(@type = 'MoreInfo')]]"/>
</xsl:template>
<xsl:template match="jnl:citref">
<xsl:choose>
<xsl:when test="contains(@rids,' ')">  
<xsl:variable name="rline" select="node()"/>
<xsl:variable name="tline"><xsl:apply-templates /></xsl:variable>
<xsl:choose>
...
<xsl:template match="jnl:cit[ancestor::jnl:abstract[parent::jnl:doc]] |jnl:cit[ancestor::jnl:back] | jnl:cit[ancestor::jnl:letter] | jnl:cit[ancestor::jnl:book-rev]" mode="refer">
<xsl:text>b</xsl:text>
<xsl:variable name="Number"><xsl:value-of select="substring-after(@id,'ref')"/></xsl:variable>
<xsl:value-of select="$Number"/>
</xsl:template>
...
<xsl:choose>
<xsl:when test="@num and starts-with(@num , 's')"><xsl:text>1</xsl:text></xsl:when>
<xsl:when test="@num and starts-with(@num , 'S')"><xsl:text>1</xsl:text></xsl:when>
</xsl:choose>
</xsl:template>
...
<xsl:choose>
<xsl:when test="$ftype = ''">
<xsl:variable name="fid"><xsl:value-of select="substring-after(@rids,'fig')"/></xsl:variable>
...
<xsl:text>nt</xsl:text><xsl:value-of select="substring-after(@rids,'tfootnote') + 100"/>
<xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
<xsl:apply-templates />
<xsl:text disable-output-escaping="yes">&lt;/xref&gt;</xsl:text>
</xsl:when>
...
<xsl:text disable-output-escaping="yes">&lt;xref ref-type="bibr" rid="</xsl:text>
<xsl:text>nr</xsl:text><xsl:value-of select="substring-after(@rids,'noteref')"/>
<xsl:text disable-output-escaping="yes">"&gt;</xsl:text>
<xsl:apply-templates />
<xsl:text disable-output-escaping="yes">&lt;/xref&gt;</xsl:text>
</xsl:when>
...
<xsl:apply-templates select="//jnl:footnote[not(ancestor::jnl:author-grp) and @id = $fid]" mode="backfootref"/>
</xsl:variable>
<xsl:text disable-output-escaping="yes">&lt;xref ref-type="fn" rid="</xsl:text>
...
<xsl:variable name="fid"><xsl:value-of select="substring-after(@rids,'tbl')"/></xsl:variable>
<xsl:variable name="fids"><xsl:value-of select="@rids"/></xsl:variable>
<xsl:variable name="ftype">
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'BIN'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'bin'">
...
<xsl:variable name="fid"><xsl:value-of select="substring-after(@rids,'equ')"/></xsl:variable>
<xsl:variable name="fids"><xsl:value-of select="@rids"/></xsl:variable>
...
<xsl:variable name="normal-attr-value" select="concat(normalize-space($rids-attribute-value), ' ')"/>
<xsl:if test="$normal-attr-value != ' '">
<xsl:variable name="first" select="substring-before($normal-attr-value,' ')"/>
...
<xsl:variable name="first1" select="substring-before($rids-text,'&amp;semi;')"/>
<xsl:variable name="rest1" select="substring-after($rids-text,'&amp;semi;')"/>
<xsl:if test="$CustCode = 'plos'">
<xsl:text disable-output-escaping="yes"> &amp;lsqb;</xsl:text>
</xsl:if>
...
<xsl:when test="$rest != ''">
<xsl:choose>
<xsl:when test="contains($rest,';') and not(contains($rest, '&amp;'))">                                                                                 
<xsl:text disable-output-escaping="yes">&amp;</xsl:text>
</xsl:when>
...
<xsl:otherwise>
<xsl:variable name="start2" select="substring-before($rest,'&amp;')"/>	
<xsl:choose>
...
<xsl:variable name="subsect" select="count($isect/preceding-sibling::jnl:section) + 1"/>
<xsl:call-template name="sectionida">
...
<xsl:value-of select="count($isect/preceding::jnl:section[parent::jnl:app]) + 1"/>
</xsl:when>
<xsl:otherwise>
<xsl:text>1</xsl:text>
</xsl:otherwise>
...
<xsl:choose>
<xsl:when test="$CustCode = 'plos'">
<xsl:variable name="subsect" select="count(preceding-sibling::jnl:section[not(@type = 'Contributions')]) + 1"/>
<xsl:call-template name="sectionida">
<xsl:with-param name="inumb" select="$subsect"/>
</xsl:call-template>
</xsl:when>
<xsl:when test="preceding-sibling::jnl:section">
<xsl:variable name="subsect" select="count(preceding-sibling::jnl:section) + 1"/>
<xsl:call-template name="sectionida">
<xsl:with-param name="inumb" select="$subsect"/>
</xsl:call-template>
</xsl:when>
...
<xsl:choose>
<xsl:when test="$CustCode = 'plos'">
<xsl:value-of select="count(preceding-sibling::jnl:section[not(@type = 'Contributions')]) + 1"/>
</xsl:when>
<xsl:when test="preceding-sibling::jnl:section">
...
<xsl:choose>
<xsl:when test="parent::jnl:letter and not(preceding-sibling::jnl:section) and not(following-sibling::jnl:section) and not(jnl:title) and //jnl:salutation/node()">
<xsl:element name="title">
...
<xsl:when test="@type and @type = 'EthicsApproval' and //jnl:jnl-info/jnl:abrv-jnl-tl[. = 'BAM'  or . = 'bam']"/>
<xsl:when test="@type and @type = 'PatientConsent' and //jnl:jnl-tl[. = 'BMJ Case Reports' or . = 'BMJ Case Report']"/>
...
<xsl:choose>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'Excel')">
<xsl:text>1</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'EXCEL')">
<xsl:text>1</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'Adobe')">
<xsl:text>3</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'ADOBE')">
<xsl:text>3</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'Word')">
<xsl:text>2</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'WORD')">
<xsl:text>2</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'Tiff')">
<xsl:text>4</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'TIFF')">
<xsl:text>4</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'PostScript')">
<xsl:text>5</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 2 ]/. ,'POSTSCRIPT')">
<xsl:text>5</xsl:text>
...
<xsl:choose>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'Excel')">
<xsl:text>1</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'EXCEL')">
<xsl:text>1</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'Adobe')">
<xsl:text>3</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'ADOBE')">
<xsl:text>3</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'Word')">
<xsl:text>2</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'WORD')">
<xsl:text>2</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'Tiff')">
<xsl:text>4</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'TIFF')">
<xsl:text>4</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'PostScript')">
<xsl:text>5</xsl:text>
</xsl:when>
<xsl:when test="contains(jnl:section/node()[position() = 1 ]/. ,'POSTSCRIPT')">
<xsl:text>5</xsl:text>
...
<xsl:text>s</xsl:text>
<xsl:choose>
<xsl:when test="parent::jnl:section[@type and @type = 'TextBox']/jnl:section/jnl:title[. = 'Commentary']">
<xsl:variable name="start1" select="count(parent::jnl:section/preceding-sibling::jnl:section[@type and @type = 'TextBox']/jnl:section/jnl:title[. = 'Commentary']) + 1"/>	
<xsl:variable name="start2" select="count(//jnl:body/jnl:section[not(@type and @type = 'TextBox' and jnl:section/jnl:title[. = 'Commentary']) and not(@type = 'Funding')])"/>
...
<xsl:choose>
<xsl:when test="preceding-sibling::jnl:section">
<xsl:value-of select="count(preceding-sibling::jnl:section[not(@type = 'Funding') and not(jnl:section/jnl:title[. = 'Commentary'])]) + 1"/>
</xsl:when>
<xsl:otherwise>
<xsl:text>1</xsl:text>
</xsl:otherwise>
...
<xsl:variable name="Name2" select="translate($Name , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
<xsl:choose>
...
<xsl:attribute name="id"><xsl:text>sa</xsl:text>
<xsl:call-template name="sectionid">
<xsl:with-param name="isect" select="parent::jnl:section"/>
</xsl:call-template>
...
<xsl:attribute name="id"><xsl:text>sa</xsl:text><xsl:value-of select="count(preceding::jnl:section[parent::jnl:app]) + 1"/></xsl:attribute>
</xsl:when>
<xsl:otherwise>
<xsl:attribute name="id"><xsl:text>sa1</xsl:text></xsl:attribute>
</xsl:otherwise>
</xsl:choose>
</xsl:otherwise>
</xsl:choose>
...
<xsl:choose>
<xsl:when test="preceding-sibling::jnl:section">
<xsl:text>sa</xsl:text><xsl:value-of select="count(preceding-sibling::jnl:section) + 1"/>
</xsl:when>
<xsl:otherwise>
...
<xsl:choose>
<xsl:when test=". = 'Commentary' and parent::jnl:section/parent::jnl:section[@type and @type = 'TextBox']">
<xsl:call-template name="newline"/>
<xsl:text disable-output-escaping="yes">&lt;title&gt;</xsl:text>
<xsl:text disable-output-escaping="yes">&lt;/title&gt;</xsl:text>
<xsl:call-template name="newline"/>
...
<xsl:element name="title">
<xsl:choose>
<xsl:when test="parent::jnl:section[@type and contains(@type ,'.f') and ancestor::jnl:section[@type and @type = 'Methods']]">
...
<xsl:variable name="vmonth"><xsl:value-of select="."/></xsl:variable>
<xsl:element name="month">
<xsl:choose>
...
<xsl:element name="fn">
<xsl:attribute name="id"><xsl:text>fn1</xsl:text></xsl:attribute>
...
<xsl:choose>
<xsl:when test="node()[position() = 1 and self::text() and contains(self::text(), 'Action Editor')]">
<xsl:variable name="content">
<xsl:apply-templates />
</xsl:variable>
...
<xsl:value-of select="normalize-space(substring-after($content,'Action Editors,'))"/>
</xsl:when>
<xsl:when test="contains($content, 'Action Editors.')">
<xsl:value-of select="normalize-space(substring-after($content,'Action Editors.'))"/>
</xsl:when>
...
<xsl:value-of select="normalize-space(substring-after($content,'Action Editor,'))"/>
</xsl:when>
<xsl:when test="contains($content, 'Action Editor.')">
<xsl:value-of select="normalize-space(substring-after($content,'Action Editor.'))"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="$part1b != '' and part1bb != '' and not(contains(part1bb, '&amp;amp;'))">
<xsl:call-template name="spliteditor">
...
<xsl:when test="contains($corr , 'CORRESP')">
<xsl:element name="corresp">
<xsl:attribute name="id"><xsl:text>cor1</xsl:text></xsl:attribute>
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'CES'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'ces'">
<xsl:choose>
<xsl:when test="@num and @num != ''">
...
<xsl:attribute name="fn-type"><xsl:text>equal</xsl:text></xsl:attribute>
<xsl:choose>
<xsl:when test="//jnl:jnl-info/jnl:abrv-jnl-tl = 'CES'  or //jnl:jnl-info/jnl:abrv-jnl-tl = 'ces'">
<xsl:choose>
<xsl:when test="@num and @num != ''">
...
<xsl:value-of select="substring-after(@id,'fn') - count(//jnl:footnote[ancestor::jnl:author-grp])"/>
</xsl:when>
<xsl:when test="@id and @id != ''">
<xsl:value-of select="@id"/>
</xsl:when>
...
<xsl:attribute name="id">
<xsl:text>n</xsl:text>
<xsl:value-of select="count(preceding-sibling::jnl:corresponding-author) + count(ancestor::jnl:author-grp/preceding-sibling::jnl:author-grp/jnl:corresponding-author) + 101"/>
</xsl:attribute>
...
<xsl:apply-templates />
<xsl:if test="following-sibling::jnl:org-name/node() | following-sibling::jnl:org-div/node()">
<xsl:text>, </xsl:text>
</xsl:if>
</xsl:template> 
...
<xsl:template match="jnl:street | jnl:city | jnl:state| jnl:postcode | jnl:postbox | jnl:addr-cpn" mode="affs">
<xsl:apply-templates />
<xsl:choose>
...
<xsl:when test="following-sibling::jnl:street/node() | following-sibling::jnl:city/node() | following-sibling::jnl:state/node()">
<xsl:text>, </xsl:text>
</xsl:when>
</xsl:choose>
</xsl:template> 
...
<xsl:variable name="content" select="."/>
<xsl:variable name="subcont"><xsl:value-of select="substring($content,1,3)"/></xsl:variable>
<xsl:variable name="content1">
<xsl:choose>
<xsl:when test="$subcont = 'Fig' or $subcont = 'fig'">
<xsl:variable name="start"><xsl:value-of select="substring-after($content,' ')"/></xsl:variable>
...
<xsl:variable name="content" select="."/>
<xsl:variable name="start"><xsl:value-of select="substring($content,1,1)"/></xsl:variable>
<xsl:variable name="content1">
<xsl:choose>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::processing-instruction('FIGTITLE')] and $start = ' '">
...
<xsl:variable name="content1" select="."/>
<xsl:choose>
<xsl:when test="$RefSup = '1' and ancestor::jnl:citref and ancestor::jnl:emph[@type = 'smallcaps']">
<xsl:value-of select="translate($content1 , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
</xsl:when>
...
<xsl:template match="text()[ancestor::jnl:jnl-info or ancestor::jnl:unit-info or ancestor::jnl:front]" priority="100">
<xsl:variable name="content" select="."/>
<xsl:value-of select="$content"/>
</xsl:template>
...
<xsl:when test="$Type = 0 and string-length($first) = 1 and not(ancestor::jnl:emph[@type = 'smallcaps'])">
<xsl:value-of select="translate($first , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
</xsl:when>
<xsl:when test="$Type = 0 and not(ancestor::jnl:emph[@type = 'smallcaps']) and string-length($first &gt; 2)">
<xsl:choose>
<xsl:when test="starts-with($first, 'mc') or starts-with($first, 'MC') or starts-with($first, 'Mc') or starts-with($first, 'mC')">
<xsl:text>Mc</xsl:text>
<xsl:variable name="start"><xsl:value-of select="substring($first,3,1)"/></xsl:variable>
<xsl:variable name="end"><xsl:value-of select="substring($first,4)"/></xsl:variable>
<xsl:value-of select="translate($start , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
<xsl:value-of select="translate($end , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:when>
<xsl:otherwise> 
<xsl:variable name="start"><xsl:value-of select="substring($first,1,1)"/></xsl:variable>
<xsl:variable name="end"><xsl:value-of select="substring($first,2)"/></xsl:variable>
<xsl:value-of select="translate($start , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
<xsl:value-of select="translate($end , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:otherwise>
</xsl:choose>
...
<xsl:value-of select="translate($Chars , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:when>
<xsl:when test="$Type = 0 and string-length($Chars) = 1 and not(ancestor::jnl:emph[@type = 'smallcaps'])">
<xsl:value-of select="translate($Chars , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
</xsl:when>
<xsl:when test="$Type = 0 and not(ancestor::jnl:emph[@type = 'smallcaps']) and string-length($Chars &gt; 2)">
<xsl:choose>
<xsl:when test="starts-with($Chars, 'mc') or starts-with($Chars, 'MC') or starts-with($Chars, 'Mc') or starts-with($Chars, 'mC')">
<xsl:text>Mc</xsl:text>
<xsl:variable name="start"><xsl:value-of select="substring($Chars,3,1)"/></xsl:variable>
<xsl:variable name="end"><xsl:value-of select="substring($Chars,4)"/></xsl:variable>
<xsl:value-of select="translate($start , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
<xsl:value-of select="translate($end , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:when>
<xsl:otherwise> 
<xsl:variable name="start"><xsl:value-of select="substring($Chars,1,1)"/></xsl:variable>
<xsl:variable name="end"><xsl:value-of select="substring($Chars,2)"/></xsl:variable>
<xsl:value-of select="translate($start , 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
<xsl:value-of select="translate($end , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
</xsl:otherwise>
</xsl:choose>
...
<xsl:variable name="Surname"><xsl:apply-templates select="jnl:surname" mode="getname"/></xsl:variable>
<xsl:variable name="Forename"><xsl:apply-templates select="jnl:forename" mode="getname"/></xsl:variable>
...
<xsl:choose>
<xsl:when test="node()[position() = 1 and self::jnl:title] and node()[position() = 2 and self::jnl:term and @num]">
<xsl:value-of select="node()[position() = 2 and self::jnl:term]/@num"/>
</xsl:when>
<xsl:when test="node()[position() = 1 and self::jnl:title] and node()[position() = 2 and self::jnl:term]">
</xsl:when>
<xsl:when test="node()[position() = 1 and self::jnl:term and @num]">
<xsl:value-of select="node()[position() = 1 and self::jnl:term]/@num"/>
</xsl:when>
<xsl:when test="node()[position() = 1 and  self::jnl:term]">
</xsl:when>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@num and @num != ''">
<xsl:attribute name="prefix-word"><xsl:apply-templates select="@num"/></xsl:attribute>
</xsl:when>
<xsl:when test="$prefixw != ''">
<xsl:attribute name="prefix-word"><xsl:value-of select="$prefixw"/></xsl:attribute>
</xsl:when>
</xsl:choose>
<xsl:call-template name="newline"/>
<xsl:for-each select="node()">
...
<xsl:choose>
<xsl:when test="preceding-sibling::node()[position() = 1 and self::jnl:def-list]">
...
<xsl:when test="preceding-sibling::node()[position() = 1 and self::jnl:def] and preceding-sibling::node()[position() = 2 and self::jnl:term]">
<xsl:variable name="ntermn">
<xsl:if test="preceding-sibling::node()[position() = 2 and self::jnl:term]/@num and preceding-sibling::node()[position() = 2 and self::jnl:term]/@num != ''">
<xsl:value-of select="preceding-sibling::node()[position() = 2 and self::jnl:term]/@num"/>
</xsl:if>
</xsl:variable>
...
<xsl:when test="preceding-sibling::node()[position() = 1 and self::jnl:term]">
<xsl:variable name="ntermn">
<xsl:if test="preceding-sibling::node()[position() = 1 and self::jnl:term]/@num and preceding-sibling::node()[position() = 1 and self::jnl:term]/@num != ''">
<xsl:value-of select="preceding-sibling::node()[position() = 1 and self::jnl:term]/@num"/>
</xsl:if>
</xsl:variable>
<xsl:if test="$termn != $ntermn">
<xsl:text disable-output-escaping="yes">&lt;/def-list&gt;</xsl:text>
...
<xsl:text disable-output-escaping="yes">&lt;/term&gt;</xsl:text>
<xsl:call-template name="newline"/>
<xsl:if test="not(following-sibling::node()) or following-sibling::node()[position() = 1 and self::jnl:term]">
<xsl:text disable-output-escaping="yes">&lt;/def-item&gt;</xsl:text>
<xsl:call-template name="newline"/>
</xsl:if>
</xsl:when>
<xsl:when test="self::jnl:def">
<xsl:if test="not(preceding-sibling::node()) or preceding-sibling::node()[position() = 1 and self::jnl:def]">
<xsl:text disable-output-escaping="yes">&lt;def-item&gt;</xsl:text>
<xsl:call-template name="newline"/>
<xsl:text disable-output-escaping="yes">&lt;term&gt;</xsl:text>
<xsl:text disable-output-escaping="yes">&lt;/term&gt;</xsl:text>
...
<xsl:attribute name="list-content"><xsl:text>key</xsl:text></xsl:attribute>
</xsl:if>
<xsl:if test="@num">
<xsl:attribute name="prefix-word"><xsl:apply-templates select="@num"/></xsl:attribute>
</xsl:if>
...
<xsl:when test="@affs and @affs != ''">  
<xsl:variable name="rrids" select="@affs"/>
<xsl:apply-templates select="following-sibling::jnl:aff[@id = $rrids]" mode="Refersemail"/>
</xsl:when>
<xsl:otherwise>
...
<xsl:when test="$content = 'colon'"><xsl:text>:</xsl:text></xsl:when>
<xsl:when test="$content = 'commat' and ancestor::jnl:email"><xsl:text>@</xsl:text></xsl:when>
<xsl:when test="$content = 'hyphen'"><xsl:text disable-output-escaping="yes">-</xsl:text></xsl:when>
<xsl:when test="$content = 'sol'"><xsl:text disable-output-escaping="yes">/</xsl:text></xsl:when>
<xsl:otherwise>
<xsl:text disable-output-escaping="yes">&amp;</xsl:text>
<xsl:value-of select="$content"/>  
...
<xsl:element name="article-id">
<xsl:attribute name="pub-id-type">publisher-id</xsl:attribute>
<xsl:apply-templates select="ancestor::jnl:doc/jnl:abstract[1]/jnl:unit-info/jnl:c-tracker-id/."/>
</xsl:element>
<xsl:element name="article-categories">
<xsl:element name="subj-group">
<xsl:attribute name="subj-group-type">
...
<xsl:choose>
<xsl:when test="jnl:author-grp/node()[self::jnl:author or self::jnl:aff or self::jnl:dept-list]">
<xsl:element name="p">
<xsl:choose>
...
<xsl:when test="@affs and @affs != ''">  
<xsl:variable name="rrids" select="@affs"/>
<xsl:apply-templates select="following-sibling::jnl:aff[@id = $rrids]" mode="Referss"/>
</xsl:when>
</xsl:choose>
</xsl:if>
<xsl:for-each select="node()">
...
<xsl:when test="self::jnl:footnote">
</xsl:when>
...
<xsl:choose>
<xsl:when test="following-sibling::node()[position() = 1 and self::jnl:noteref]"/>
<xsl:when test="following-sibling::node()[position() = 1 and self::jnl:footnote]"/>
<xsl:when test="following-sibling::node()">
<xsl:text> </xsl:text>
</xsl:when>
</xsl:choose>
...
<xsl:when test="parent::jnl:author-grp/following-sibling::jnl:author-grp/jnl:author">
<xsl:text>, </xsl:text>
</xsl:when>
</xsl:choose>
</xsl:for-each>
<xsl:text>.</xsl:text>
<xsl:if test="jnl:author-grp/node()[self::jnl:aff or self::jnl:dept-list]">
<xsl:text> </xsl:text>
</xsl:if>
</xsl:when>
</xsl:choose>
<xsl:choose>
<xsl:when test="jnl:author-grp/node()[self::jnl:aff or self::jnl:dept-list]">
<xsl:if test="//jnl:bmj-module-no/. = '3'">
<xsl:text disable-output-escaping="yes">&lt;italic&gt;</xsl:text>
</xsl:if>
<xsl:for-each select="jnl:author-grp/node()[self::jnl:aff or self::jnl:dept-list]">
<xsl:choose>
...
<xsl:apply-templates select="jnl:hdr-txt" mode="affs"/>
<xsl:text> </xsl:text>
</xsl:if>
...
<xsl:if test="jnl:org-name/node() or jnl:address/node()/node()">
<xsl:text>, </xsl:text>
<xsl:if test="jnl:org-name/node()">
<xsl:apply-templates select="jnl:org-name/node()"/>
<xsl:if test="jnl:address/node()/node()">
...
<xsl:when test="parent::jnl:author-grp/following-sibling::jnl:author-grp/jnl:aff">
<xsl:text>, </xsl:text>
</xsl:when>
<xsl:when test="parent::jnl:author-grp/following-sibling::jnl:author-grp/jnl:dept-list">
<xsl:text>, </xsl:text>
</xsl:when>
</xsl:choose>
</xsl:for-each>
...
<xsl:choose>
<xsl:when test="node()[position() = 1 and self::jnl:title[node()]] and node()[position() = 2 and self::jnl:p[node()]]">
<xsl:element name="p">
<xsl:text disable-output-escaping="yes">&lt;bold&gt;</xsl:text>
...
<xsl:when test="node()[position() = 1 and self::jnl:title] and node()[position() = 2 and self::jnl:p[node()]]">
<xsl:apply-templates select="node()[position() &gt; 1]"/>
</xsl:when>
<xsl:when test="node()[position() = 1 and self::jnl:title[node()]] and node()[position() = 1 and self::jnl:p]">
<xsl:element name="p">
<xsl:text disable-output-escaping="yes">&lt;bold&gt;</xsl:text>
<xsl:apply-templates select="node()[position() = 1]/node()"/>
<xsl:text disable-output-escaping="yes">&lt;/bold&gt;</xsl:text>
...
<xsl:when test="$content = 'emsp' and parent::jnl:p[parent::tbl:entry] and preceding-sibling::node()[not(self::processing-instruction('ENTCHAR')[. = 'emsp'])]">
...
<xsl:variable name="rtext" select="translate($stext , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')"/>
<xsl:choose>
<xsl:when test="contains($rtext , 'faculty')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'school')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'department')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'college')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'centre')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'center')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'human')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'development')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'health')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'university')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'hospital')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'universidad')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'institut')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'laborat&amp;oacute;rio')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'servi&amp;ccedil;o')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'superior')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'tecnologia')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'faculdade')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'medicina')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'research')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'ucla')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'group')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'registry')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'unit')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'primary care')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'idiap jordi gol')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'medical care')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'nui galway')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'hse west')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'direction')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'politique')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'm&amp;eacute;dicale')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'ap-hp')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'ceis sanit&amp;agrave;')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'facolt&amp;agrave;')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'economia')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'cnr')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'sanit&amp;agrave;')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'pubblica')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'eurocat')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'st george&amp;rsquo;s')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'division')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'associates')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'obstetrics')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'paediatrics')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'society')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'medicine')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'asl roma')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'office')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'service')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'biostatistics')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'laboratory')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'epidemiology')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'demography')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'biometry')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'front')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'national')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'laboratories')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'diabetes')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'obstetrics')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'foundation')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'trust')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'hsph')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'oncology')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'reproductive')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'anaesthesia')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'academy')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'collegium')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'studies')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'agency')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'service')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'transport')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'section')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'clinical')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , '&amp;agrave;rea')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'ib&amp;lowbar;salut')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'foundation')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'region')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'informatics')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'studies')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'ucl')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'hsmc')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'universit&amp;eacute;')"><xsl:text> </xsl:text></xsl:when>
<xsl:when test="contains($rtext , 'cetaf-rppc')"><xsl:text> </xsl:text></xsl:when>
</xsl:choose>
</xsl:template>
...
<xsl:value-of disable-output-escaping="yes" select="substring-before($ridstext ,',')"/>	
</xsl:when>
<xsl:otherwise>
...
<xsl:choose>
<xsl:when test="contains($ridstext , ',')">
<xsl:value-of disable-output-escaping="yes" select="substring-after($ridstext ,',')"/>	
</xsl:when>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="contains($normal-attr-value ,  ',')">
<xsl:variable name="first" select="normalize-space(substring-before($normal-attr-value,','))"/>
<xsl:variable name="rest" select="normalize-space(substring-after($normal-attr-value,','))"/>
<xsl:for-each select="following-sibling::jnl:aff/jnl:address/jnl:addr-cpn/jnl:emph[@type and @type = 'sup' and . = $first]">
<xsl:variable name="tcount" select="count(ancestor::jnl:abstract/preceding-sibling::jnl:abstract) + 1"/>
<xsl:text disable-output-escaping="yes">&lt;xref ref-type="aff" rid="aff</xsl:text>
<xsl:choose>
<xsl:when test="parent::jnl:addr-cpn/node()[position() = 1 and self::jnl:emph[@type and @type = 'sup']]">
<xsl:value-of select="count(preceding-sibling::jnl:emph[@type and @type = 'sup']) + 1"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="count(preceding-sibling::jnl:emph[@type and @type = 'sup']) + 2"/>
</xsl:otherwise>
</xsl:choose>
<xsl:text>-</xsl:text>
<xsl:choose>
...
<xsl:otherwise>
<xsl:for-each select="following-sibling::jnl:aff/jnl:address/jnl:addr-cpn/jnl:emph[@type and @type = 'sup' and . = $rids-attribute-value]">
<xsl:variable name="tcount" select="count(ancestor::jnl:abstract/preceding-sibling::jnl:abstract) + 1"/>
<xsl:text disable-output-escaping="yes">&lt;xref ref-type="aff" rid="aff</xsl:text>
<xsl:choose>
<xsl:when test="parent::jnl:addr-cpn/node()[position() = 1 and self::jnl:emph[@type and @type = 'sup']]">
...
<xsl:variable name="refer" select="substring-before(substring-after($value , '&amp;') , ';')"/>
<xsl:variable name="rest" select="substring-after(substring-after($value , '&amp;') , ';')"/>
<xsl:if test="$first != ''">
<xsl:value-of select="$first"/>
</xsl:if>
<xsl:if test="$refer != ''">
...
<xsl:variable name="CorSurname"><xsl:apply-templates select="jnl:surname/."/></xsl:variable>
<xsl:variable name="CorForename"><xsl:apply-templates select="jnl:forename/."/></xsl:variable>
<xsl:for-each select="//jnl:corresponding-author">
<xsl:choose>
<xsl:when test="jnl:surname and jnl:forename">
<xsl:variable name="Surname"><xsl:apply-templates select="jnl:surname" mode="getname"/></xsl:variable>
...
<xsl:choose>
<xsl:when test="jnl:surname and jnl:forename and //jnl:corresponding-author">
<xsl:variable name="Surname"><xsl:apply-templates select="jnl:surname/."/></xsl:variable>
<xsl:variable name="Forename"><xsl:apply-templates select="jnl:forename/."/></xsl:variable>
...
<xsl:if test="$CorresAuthor = '0'">
<xsl:choose>
<xsl:when test="$AuthCorr = '1' and jnl:role/. = 'Corresponding author' and //jnl:corresponding-author">
</xsl:when>
<xsl:when test="$AuthCorr = '1' and jnl:role/. = 'Corresponding Author' and //jnl:corresponding-author">
</xsl:when>
<xsl:when test="jnl:surname and jnl:forename and //jnl:corresponding-author">
...
<xsl:variable name="CorAuthors">
<xsl:choose>
<xsl:when test="preceding-sibling::jnl:corresponding-author or ancestor::jnl:author-grp/preceding-sibling::jnl:author-grp/jnl:corresponding-author">
<xsl:value-of select="count(preceding-sibling::jnl:corresponding-author) + count(ancestor::jnl:author-grp/preceding-sibling::jnl:author-grp/jnl:corresponding-author) + 101"/>                        
</xsl:when>
<xsl:otherwise>
...
<xsl:attribute name="rid"><xsl:text>fn1</xsl:text></xsl:attribute>
<xsl:choose>
<xsl:when test="$CustCode = 'plos'">
...
<xsl:if test="$value != ''">
<xsl:choose>
<xsl:when test="$Tvalue = 'findings that shed new light on the possible pathogenesis of a disease or an adverse effect'">
...
<xsl:when test="$Tvalue = 'novel treatment (new drug/intervention; established drug/procedure in new situation)'">
...
<xsl:when test="$Tvalue = 'unexpected outcome (positive or negative) including adverse drug reactions'">
...
<xsl:choose>
<xsl:when test="$first != ''">
<xsl:variable name="firstt" select="translate($first , '1234567890,', '')"/>
...
<xsl:variable name="refer" select="substring-before(substring-after($value , '&lt;?ENTCHAR ') , '?&gt;')"/>
<xsl:variable name="rest" select="substring-after($value , '?&gt;')"/>
<xsl:if test="$first != ''">
<xsl:value-of select="$first"/>
</xsl:if>
<xsl:choose>
<xsl:when test="$refer != '' and $refer = 'hairsp' and $rest != '' and  starts-with($rest , '&lt;?ENTCHAR equals?&gt;')"/>
<xsl:when test="$refer != ''">
...
<xsl:choose>
<xsl:when test="$refer != '' and $refer = 'equals' and $rest != '' and  starts-with($rest , '&lt;?ENTCHAR hairsp?&gt;')">
<xsl:variable name="rest2" select="substring-after($rest , '&lt;?ENTCHAR hairsp?&gt;')"/>
<xsl:if test="$rest2 != ''">
...
<xsl:choose>
<xsl:when test="$refer != '' and $refer = 'hairsp' and $rest != '' and  starts-with($rest , '|##|equals|###|')"/>
<xsl:when test="$refer != ''">
<xsl:call-template name="write-ent-text">
<xsl:with-param name="content" select="$refer"/>
</xsl:call-template>
...
<xsl:choose>
<xsl:when test="$refer != '' and $refer = 'equals' and $rest != '' and  starts-with($rest , '|##|hairsp|###|')">
<xsl:variable name="rest2" select="substring-after($rest , '|##|hairsp|###|')"/>
<xsl:if test="$rest2 != ''">
<xsl:call-template name="write-num-text">
<xsl:with-param name="value" select="$rest2"/>
</xsl:call-template>
...
<xsl:variable name="first1" select="translate($first , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', '')"/>
<xsl:variable name="rest1" select="normalize-space(substring-before($rest,' '))"/>
<xsl:variable name="rest2">
<xsl:choose>
<xsl:when test="$rest1 != ''">
<xsl:value-of select="translate($rest1 , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', '')"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="translate($rest , 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', '')"/>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
<xsl:choose>
...
<xsl:choose>
<xsl:when test="$rest1 != ''">
<xsl:variable name="rest3" select="normalize-space(substring-after($rest,' '))"/>
<xsl:text disable-output-escaping="yes">&lt;given-names&gt;</xsl:text>
...
<xsl:variable name="content3" select="substring($content2, string-length($content2) , 1)"/>
<xsl:choose>
<xsl:when test="$content3 = '.'">
<xsl:call-template name="write-text">
<xsl:with-param name="value" select="substring($content2, 1, string-length($content2)-1)"/>
</xsl:call-template>
</xsl:when>
<xsl:otherwise>
<xsl:call-template name="write-text">
...
<xsl:otherwise>
<xsl:variable name="content2" select="normalize-space($first5)"/>
<xsl:variable name="content3" select="translate($content2 , '1234567890.', '')"/>
<xsl:choose>
...
<xsl:variable name="fid"><xsl:value-of select="count(preceding::jnl:equ) + 1"/></xsl:variable>
<xsl:variable name="jabrv"></xsl:variable>
<xsl:choose>
...
<xsl:if test="$normal-attr-value != ' '">
<xsl:choose>                 
<xsl:when test="$rest !='' and $starta = '' and $startb = '' and $startc = '' and $startd = ''">
<xsl:text disable-output-escaping="yes">&lt;xref ref-type="bibr" rid="</xsl:text>
<xsl:variable name="rrids" select="$first"/>
<xsl:choose>
<xsl:when test="//jnl:cit[@id = $rrids]">
...
<xsl:when test="$rest !='' and $starta !='' and not(contains($starta , ',')) and not(contains($starta , ' ')) and not(contains($starta , '-'))">
...
<xsl:when test="$rest !='' and $startb !='' and not(contains($startb , ' ')) and not(contains($startb , '-'))">
...
<xsl:text>-</xsl:text>
<xsl:choose>
<xsl:when test="$nextd != '' and $startdA != '' and not(contains($startdA , ',')) and not(contains($startdA , ' ')) and not(contains($startdA , '-'))">
...
<xsl:when test="$nextd != '' and $startdB != '' and not(contains($startdB , ' ')) and not(contains($startdB , '-'))">
<xsl:variable name="tstr" select="substring-before($nextd ,',')"/>	
<xsl:call-template name="write-refs-ndashm">
<xsl:with-param name="rids-attribute-value" select="$rest"/>
<xsl:with-param name="rids-content" select="$rest"/>
...
<xsl:when test="$nextd != '' and $startdC != '' and not(contains($startdC , '-'))">
<xsl:variable name="tstr" select="substring-before($nextd ,' ')"/>	
<xsl:call-template name="write-refs-ndashm">
<xsl:with-param name="rids-attribute-value" select="$rest"/>
<xsl:with-param name="rids-content" select="$rest"/>
...
<xsl:when test="$rest !='' and $starta !='' and not(contains($starta , ',')) and not(contains($starta , ' '))">
<xsl:text disable-output-escaping="yes">&lt;xref ref-type="bibr" rid="</xsl:text>
<xsl:variable name="rrids" select="$first"/>
<xsl:choose>
<xsl:when test="//jnl:cit[@id = $rrids]">
...
<xsl:with-param name="rids-attribute-value" select="$rids-attribute-value"/>
<xsl:with-param name="rids-content" select="$rids-content"/>
<xsl:with-param name="rids-text" select="$rids-text"/>
</xsl:call-template>
</xsl:when>
...
<xsl:template name="removespace" mode="justname">
<xsl:param name="Chars"/>
...
<xsl:template name="sectionida" mode="secrefer">
<xsl:param name="inumb"/>
<xsl:param name="ipart"/>
...
<xsl:template name="sectionid" mode="secrefer">
<xsl:param name="isect"/>
<xsl:choose>
<xsl:when test="$isect/ancestor::jnl:section and $isect/parent::jnl:section">
<xsl:variable name="start" select="count($isect/ancestor::jnl:section)"/>	
...
<xsl:template name="splitcorrs" mode="corraff">
<xsl:param name="Chars"/>
...
<xsl:text disable-output-escaping="yes">&lt;email xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple"&gt;</xsl:text>
...
<xsl:template name="check-address" mode="sub-art">
<xsl:param name="stext"/>
...
<xsl:template name="write-address" mode="sub-art">
<xsl:param name="ridstext"/>
<xsl:param name="ridstag"/>
...
<xsl:template name="write-affsnum" mode="sub-art">
<xsl:param name="rids-attribute-value"/>
...
<xsl:template name="write-content" mode="corraff">
<xsl:param name="value"/>
<xsl:if test="$value != ''">
...
<xsl:template name="write-ent" mode="corraff">
<xsl:param name="content"/>
...
<xsl:when test="$content = 'lpar' and not(ancestor::jnl:abstract)">
<xsl:text>(</xsl:text>
</xsl:when>
<xsl:when test="$content = 'rpar' and not(ancestor::jnl:abstract)">
<xsl:text>)</xsl:text>
</xsl:when>
<xsl:when test="$content = 'lpar'">
<xsl:text disable-output-escaping="yes">&amp;lpar;</xsl:text>
...
<xsl:template name="SentenceCase" mode="sentence">
<xsl:param name="Chars"/>
<xsl:param name="Type"/>
